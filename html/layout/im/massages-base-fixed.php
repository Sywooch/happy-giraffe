<!DOCTYPE html>
<!--[if lt IE 8]>      <html class="im-fixed ie7"> <![endif]-->
<!--[if IE 8]>         <html class="im-fixed ie8"> <![endif]-->
<!--[if IE 9]>         <html class="im-fixed ie9"> <![endif]-->
<!--[if gt IE 9]><!--> <html class="im-fixed"> <!--<![endif]-->
<head>
...
im.messagesHeight = function () {
	var h = im.windowHeight - im.headerHeight - im.topHeight - im.bottom.height() - 31; // 31 - отступы в блоках
	im.hold.height(h);
}

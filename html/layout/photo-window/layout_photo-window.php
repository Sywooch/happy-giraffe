...
<div class="photo-window_w">
	...
	<div class="photo-window_c">
		...
		<a href="" class="photo-window_arrow photo-window_arrow__l"></a>
		<a href="" class="photo-window_arrow photo-window_arrow__r"></a>
	...
	<div class="photo-window_bottom">
		...
		<div class="photo-window_desc">
			...
			<p>В круглогодичном лечебно-развлекательном лагере «Зеркальный» ежедневно проводятся разнообразные мероприятия и программы - тематические, творческие и интеллектуальные конкурсы, концерты, викторины, активные и спокойные игры, эстафеты, соревнования активные и спокойные игры  </p>
		</div>
	</div>

        ...
        <div class="block">
            ...
            <div class="visits-row">
                <div class="visits-filter">
                    <a href="" class="visits-filter_i active">По дате</a>
                    <a href="" class="visits-filter_i">По трафику</a>
                </div>
            ...
            <table class="visits-table">
                ...
                <tr class="">
                    ...
                    <td class="visits-table_td-count">
                        <div class="visits-table_count">64</div>
                    </td>
                </tr>
                <tr class="">
                    <td class="visits-table_td-link" colspan="2">
                        <a href="">Нажмите кнопку «Подписаться» внизу страницы с объявлениями </a>
                    </td>
                    <td class="visits-table_td-count">
                        <div class="visits-table_count">623424</div>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr class="visits-table_odd">
                    <td class="visits-table_td-date">
                        <div class="b-date">21 ФЕВРАЛЯ 2013</div>
                    </td>
                    <td class="visits-table_td-empty">&nbsp;</td>
                    <td class="visits-table_td-count">
                        <div class="visits-table_count visits-table_count__blue">62342344</div>
                    </td>
                </tr>
                <tr class="">
                    <td class="visits-table_td-link" colspan="2">
                ...
                <tr class="">
                    ...
                    <td class="visits-table_td-count">
                        <div class="visits-table_count">424</div>
                    </td>
                </tr>
            </table>
            </div>

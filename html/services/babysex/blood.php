					...
					<!-- удалены обвертки
					 ...
					 -->
						<div class="child_sex_blood_banner">
							...
							<form action="">
								<div class="man_blood">II Rh(+)</div><!-- .man_blood -->
								<div class="woman_blood">I Rh(-)</div><!-- .woman_blood -->
								...
								<!-- Две кнопки для примера. В конечном итоге они переключаеются (изменением класса) между собой при выборе групп крови родителей -->
								<input type="button" class="btn-gray-light btn-h55" value="Рассчитать" />

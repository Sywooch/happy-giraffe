					...
					<!-- удалены обвертки
					 ...
					 -->
						<div class="child_sex_china_banner">
							<!-- Заголовок -->
							<h1 class="child_sex_t">Определение пола ребенка <br> по китайскому календарю</h1>
							<form action="">
								<div class="mam_bd">
								...
								<div class="child_bd">
									...
									<ul class="lists_td">
										...
										<li>
											<select id="child_yr_cal" class="yr_cal chzn">
												<option value="1000" selected="selected">2011</option>
												<option value="1">2010</option>
												<option value="2">2009</option>
												<option value="3">2008</option>
								...
								<!-- btn-corncolor -  btn-gold -->
								<input type="button" class="btn-gold btn-big" value="Рассчитать" />
							</form>
						</div>
						<div class="month_calendar">
							...
							<table class="calendar_body">
								...
								<tr>
									<td>
										<div class="cal_item active_item boy_day">
											<i class="icon"></i>
										</div><!-- .cal_item -->
									</td>
									<td>
										<div class="cal_item girl_day">
											<i class="icon"></i>
										</div><!-- .cal_item -->
									</td>
									<td>
						...
						<div class="margin-20">
							<div class="wysiwyg-content">
								<!-- Заголовок h1 - h2 -->
							    <h2>Китайский метод определения пола ребенка</h2>

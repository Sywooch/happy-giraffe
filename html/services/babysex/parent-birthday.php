					 ...
					 -->
						<div class="child_sex_banner">
							...
							<form action="">
								<div class="dad_bd">
									...
									<ul class="lists_td">
										<li>
											<select id="dad_num_cal" class="num_cal chzn">
								...
								<div class="mam_bd">
									...
									<ul class="lists_td">
										<li>
											<select id="mam_num_cal" class="num_cal chzn">
												<option value="1000" selected="selected">1</option>
												<option value="1">2</option>
												<option value="2">3</option>
											</select>
										...
										<li>
											<select id="mam_yr_cal" class="yr_cal chzn">
												<option value="1000" selected="selected">2011</option>
												<option value="1">2010</option>
												<option value="2">2009</option>
											</select>
								...
								<div class="child_bd">
									...
									<ul class="lists_td">
										...
										<li>
											<select id="ch_mn_cal" class="mn_cal chzn">
												<option value="1000" selected="selected">декабря</option>
												<option value="1">октября</option>
												<option value="2">ноября</option>
											</select>
										...
										<li>
											<select id="ch_yr_cal" class="yr_cal chzn">
												<option value="1000" selected="selected">2011</option>
												<option value="1">2010</option>
												<option value="2">2009</option>
												<option value="3">2008</option>
						...
						<div class="margin-20">
							<div class="wysiwyg-content">
								<!-- Заголовок h2 -->
							    <h2>Пол ребенка по дате рождения родителей</h2>

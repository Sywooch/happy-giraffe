					 ...
					 -->
						...
						<div class="contractions-summary">
								...
								<table class="result-table">
									...
									<tbody>
										<tr>
											<td></td>
											<td class="col-1">1</td>
											<td class="col-2">18:32</td>
											<td class="col-3">19:12</td>
											<td class="col-4">00:40</td>
											<td class="col-5">00:25</td>
							...
							<div class="block-in">
								...
								<p>Эта страничка создана для того, чтобы попытаться помочь будущим мамам, которые сидят как на иголках и пытаются понять, что же с ними происходит: рожаем или еще не рожаем? Настоящие схватки или ложные?</p>
								<p>Управление очень простое: чтобы вести учет, можно, либо нажимать на кнопку мышкой, либо использовать, вместо неё, клавиши ENTER или ПРОБЕЛ.</p>
								<p>Если вы случайно нажали (или не нажали) что-то в нужно время (одним словом — ошиблись), можно будет подкорректировать результат кнопкой "Удалить последнюю запись", которая появится сразу, как отметите первую схватку.</p>
								
							</div>
							<div style="" class="block-in contractions-result contractions-result-9">
					            <div class="box-left">
					            ...
					            <div class="box-main">
					                ...
					                <p>Скорее всего, вы ведете счет неправильно. Постарайтесь жать на кнопку точнее &ndash; именно в момент начала схваток и в момент их окончания.</p>
					                <br>
					                <center><a href="#" class="to-contractions-data">Таблица Ваших схваток</a></center>
					            </div>
					        </div>
						</div>
					    ...
					    <div class="wysiwyg-content">
					        ...
					        <p>Уход в декретный отпуск &ndash; желанная финишная ленточка для будущей мамы. Начиная с третьего триместра женщины, ожидающие ребенка, берут в руки календарь и начинают проводить расчет декретного отпуска &ndash; подсчитывать, сколько же дней осталось до выхода в декрет.</p>

					        <div class="brushed">
					            <p>Теперь можно легко узнать об этом, воспользовавшись нашим сервисом. Всё, что нужно знать, &ndash; это предполагаемая дата родов (ПДР); количество деток, которые должны появиться в результате этой беременности; наличие у вас неиспользованных дней очередного трудового отпуска.</p>
					        </div>
					        ...
					        <p>Но самое главное: уход в декретный отпуск &ndash; ваше личное дело, и заветную дату определяете именно вы!</p>

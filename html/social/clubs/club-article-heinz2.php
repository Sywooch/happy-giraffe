...
*/
					...
					<div class="b-article_cont clearfix">
						...
						<h2 class="b-article_t">
							Каждому возрасту - своя кашка!
						</h2>
						<div class="b-article_in clearfix">
							<div class="wysiwyg-content clearfix">
								<p>	Каши богаты растительным белком, углеводами, клетчаткой, жирами, витаминами А, D, C, E, PP, группы B, а так же содержат в своем составе важные микро- и макроэлементы, ненасыщенные жирные кислоты, минеральные соли. О важности каш в питании - особенно в питании маленьких детей - знает каждая мама. Но как и, главное, когда начинать давать ребенку каши? Как разобраться во всем многообразии каш для детского питания?</p>
								<p>Надеемся, наша шпаргалка поможет вам в вопросе выбора идеальной детской каши:
								<br>
								Но прежде чем перейти к ассортименту детских каш, давайте обговорим некоторые важные моменты:</p>
								<ol>
									<li>
										<p>Ребенка раннего возраста (до 2-х лет) рекомендовано кормить специальными продуктами для детского питания, а не пищей с общего столаПродукты для детского питания специально разработаны с учетом особенностей незрелого пищеварительного тракта ребенка первых двух лет жизни, состав сбалансирован, безопасен и обеспечивает малыша необходимым гарантированным количеством микро- и макроэлементов,  витаминов и минералов. Промышленные продукты детского питания создаются с учетом потребностей крохи на каждом этапе его развития. Возраст, указанный на упаковках детского питания, является минимальным возрастом, с которого можно предлагать ребенку тот или иной продукт. Минимальным, а не рекомендованным! Т.е. если на упаковке каши написано "С 4 месяцев" - это значит, что эту кашку можно ввести и в 4 месяца, и в 5, и даже в 6, но только не в 2 месяца, и даже не в 3,5 месяца.
											<br>
											Перед введением прикорма обязательно проконсультируйтесь с Вашим педиатром. Только врач сможет оценить состояние малыша и решить пора или нет вводить новые продукты, с какой каши начать, какой объём кашки показан малышу.</p>
									</li>
									<li>
										<p>Быстрорастворимые каши для детского питания ("инстантные" каши) - это каши, приготовленные из специально отобранной для детского питаниякрупы, по классическим рецептам рецептам, созданным детскими дитеологами и гастроэнтерологами с учетом особенностей детского пищеварительного тракта. Каши создаются по особой технологии: вначале крупу мелко измельчают, затем варят, после этого получившуюся кашку высушивают, раскатывают в пласт, вновь измельчают,а затем герметично упаковывают. Таким образом, для того, чтобы приготовить детскую кашку, достаточно добавить готовую сухую смесь в теплую воду, грудное молоко или адаптированную молочную смесь.</p>
									</li>
								</ol>
								<!-- Таблица -->
								<!-- Ряд ячеек -->
								<div class="article-heinz article-heinz__green">
									<div class="article-heinz_t">
										<span class="ico-family ico-family__boy-small"></span>
										<h2 class="article-heinz_t-tx">4 месяца +</h2>
										
									</div>
									<div class="article-heinz_hold">
										<h3>Физиологические потребности (особенности) ребенка</h3>
										<p>В этом возрасте, при наличии всех признаков готовности к вводу прикорма, можно начинать знакомить малыша с продуктами, отличающимися от грудного молока/молочной смеси. Но пищеварительный тракт ребенка еще очень незрелый, поэтому в качестве прикорма можно использовать только гомогенные продукты детского питания, с низкой степенью аллергенности. </p>
										<h3>Требования к кашам</h3>
										<p>Каши для первого прикорма должны быть монокомпонентными, т.е. состоять только из одного вида крупы; безмолочными и без сахара. Крупы для первого прикорма должны быть безглютеновыми - это греча, рис или кукуруза. После ввода безглютеновых круп переходите к овсяной каше.  Готовить каши можно на воде, грудном молоке или молочной смеси, которую получает ребенок.  Желательно, чтобы каша была дополнительно обогащена витаминами и минералами, а также пищевыми волокнами,способствующими комфортному пищеварению и формированию полезной микрофлоры кишечника. </p>

										<div class="img-left">
											<img src="http://www.heinz-baby.ru/images/products/new_LA_rice.png" alt="" width="215px">
										</div>
										<h3>Рекомендуемый вид <br> детской кашки Heinz</h3>
										<p>Для этого возраста компания Heinz выпускает линейку br <a href="http://www.heinz-baby.ru/site/product/109" target="_blank">Низкоаллергенных кашек</a>: <br> гречневая, рисовая, кукурузная и первая овсяная. В составе этих кашек нет молока и сахара. Для роста и развития ребенка, кашки дополнительно обогащены 12 витаминами, 4 основными минералами, а также натуральными пищевыми волокнами - пребиотиками, полученными из цикория. Пищевые волокна служат субстратом для роста полезной микрофлоры, что способствует пищеварению, укреплению иммунитета и улучшает всасывание кальция. </p>
									</div>
								</div>
								<!-- Ряд ячеек -->
								<div class="article-heinz article-heinz__blue">
									<div class="article-heinz_t">
										<span class="ico-family ico-family__girl-small"></span>
										<h2 class="article-heinz_t-tx">6 месяцев +</h2>
										
									</div>
									<div class="article-heinz_hold">
										<h3>Физиологические потребности (особенности) ребенка</h3>
										<p>Полгода - это время появления новых навыков и продолжающегося бурного роста ребенка. Возрастает потребность в цинке, железе, а также разнообразных витаминах, необходимых для усвоения этих микроэлементов. 
										<br>
										К 6 месяцам заканчивается запас железа, полученный внутриутробно, теперь кроха будет получать железо только с питанием. Для того, чтобы железо лучше всасывалось, необходим витамин С.
										<br>
										Интенсивный рост требует больших количеств кальция и витамина Д.
										<br>
										Одновременно созревает и укрепляется пищеварительная система, малыш уже готов к тому, чтобы пробовать все более и более сложные по составу продукты.  </p>
										<h3>Требования к кашам</h3>
										<p>В этом возрасте самое время знакомить малыша с молочными кашками, а также с кашами из нескольких видов круп и кашами с добавлением фруктов и ягод. Молочные каши содержат больше кальция и легкоусвояемого молочного белка; использование сразу нескольких видов круп позволяет сочетать полезные свойства разных злаков, а добавление в кашу фруктов знакомит малыша с новыми вкусами.  </p>
										<div class="img-left">
											<img src="http://www.heinz-baby.ru/images/products/NEW_M_OAT_PEACH.png" alt="" width="215px">
										</div>
										<h3>Рекомендуемый вид детской кашки Heinz</h3>
										<p>Для этого возраста эксперты компании Heinz разработали специальную линейку <a href="http://www.heinz-baby.ru/site/product/57" target="_blank">Молочных кашек</a>, в состав которых входит цельное натуральное молоко, без замены молочных жиров растительными. В основе многих молочных кашек - сочетания злаков, а также натуральные фруктовые пюре и соки. 
										<br>
										Дополнительно все кашки Heinz обогащены пребиотиками и витаминно-минеральным комплексом из 4 минералов (кальций, железо, цинк, йод) и 12 витаминов (A, D, E, B1, B2, B6, B12, PP, C, фолиевая кислота, биотин, пантотеновая кислота). </p>
									</div>
								</div>
								<!-- Ряд ячеек -->
								<div class="article-heinz article-heinz__lilac">
									<div class="article-heinz_t">
										<span class="ico-family ico-family__girl-small"></span>
										<h2 class="article-heinz_t-tx">9 месяцев +</h2>
										
									</div>
									<div class="article-heinz_hold">
									<!-- <div class="article-inner-b"> -->
										<h3>Физиологические потребности (особенности) ребенка</h3>
										<p>Малыш растет: у него активно прорезываются зубки, он встает. ходит, держась за опору, начинает говорить первые слова. В питание к этому возрасту обычно введены все группы продуктов: каши, овощи, фрукты, мясо, рыба, молочные продукты и яичный желток. 
										<br>
										Теперь основная задача- познакомить малыша с самыми разными вкусами. Считается, что именно с этого возраста начинает формироваться вкус и пищевые пристрастия ребенка.</p>
										<h3>Требования к кашам</h3>
										<p>После 9 месяцев можно (при отсутствии аллергии!) предлагать ребенку любые крупы, а также значительно расширить ассортимент предлагаемых крохе фруктов и ягод. При этом каши по-прежнему должны обеспечивать ребенка достаточным количеством витаминов, минералов и других полезных пищевых веществ.
										<br>
										Желательно, чтобы каши содержали дополнительное количество пищевых волокон, для обеспечения нормальной моторики кишечника и укрепления иммунитета. </p>

										<div class="img-left">
											<img src="http://www.heinz-baby.ru/images/products/new_Lak_Multi_apple-cher.png" alt="" width="215px">
										</div>
										<h3>Рекомендуемый вид детской кашки Heinz</h3>
										<p>Специально для этого возраста компания Heinz разработала линейку <a href="http://www.heinz-baby.ru/site/product/64" target="_blank">«Лакомых кашек»</a>,в которых содержание молока составляет до 40 %.
										<br>
										Малышей этого возраста можно порадовать многообразными вкусами кашек - много- и одно-зерновые каши с добавлением фруктов и ягод. Как и все другие каши Heinz, «Лакомые кашки» дополнительно обогащены пребиотиками, а также витаминами и минералами для здорового развития малышей.  </p>
									</div>
								</div>
								<!-- Ряд ячеек -->
								<div class="article-heinz article-heinz__pink">
									<div class="article-heinz_t">
										<span class="ico-family ico-family__boy-small"></span>
										<h2 class="article-heinz_t-tx">12 месяцев +</h2>
										
									</div>
									<div class="article-heinz_hold">
										<h3>Физиологические потребности (особенности) ребенка</h3>
										<p>В питания малыша в этом возрасте 3 основные задачи:
											<ul>
												<li>совершенствование навыков жевания</li>
												<li>обеспечение по-прежнему высоких потребностей в витаминах и минералах</li>
												<li>постепенный переход от продуктов детского питания к продуктам и блюдам с общего стола</li>
											</ul>
										</p>
										<h3>Требования к кашам</h3>
										<p>В этом возрасте все так же рекомендовано  использовать специальные каши для детского питания. До 2-х летнего возраста ребенок еще нуждается в специальном подходе к выбору продуктов питания. Малыш уже может справиться с консистенцией обычной разваренной каши домашнего приготовления, однако, такие каши не соответствуют всем физиологическим потребностям ребенка: в процессе термической обработки разрушается слишком много полезных пищевых веществ.</p>
										<div class="img-left">
											<img src="http://www.heinz-baby.ru/images/products/new_LUBO_banan-klub.png" alt="" width="215px">
										</div>
										<h3>Рекомендуемый вид детской кашки Heinz</h3>
										<p>Кашки Heinz <a href="http://www.heinz-baby.ru/site/product/71"  target="_blank">«Любопышки»</a> для детей от 1 до 3 лет содержат необходимое количество витаминов и минералов для правильного развития малыша. Главным отличием от кашек «до года» является наличие в их составе кусочков фруктов и зерновых хлопьев, необходимых для правильного развития навыков жевания ребенка и формирования вкусовых пристрастий.  </p>
									</div>
								</div>
								<br>
								<div class="color-gray font-small">На правах рекламы. Грудное молоко – самое полезное для Вашего малыша. Перед введением прикорма проконсультируйтесь с педиатром. Возраст введения продуктов указан на упаковке. </div>
							</div>
						</div>

					...
					<div class="b-article_cont clearfix">
						...
						<div class="b-article_in clearfix">
							<div class="wysiwyg-content clearfix">
								...
								<!-- Таблица -->
								<!-- Ряд ячеек -->
								<h2>Возраст 4+ месяца</h2>
								<div class="img-right">
									<img src="http://www.heinz-baby.ru/images/products/new_LA_rice.png" alt="">
								</div>
								...
								<p>Для этого возраста компания Heinz выпускает линейку <a href="http://www.heinz-baby.ru/site/product/109" target="_blank">Низкоаллергенных кашек</a>: гречневая, рисовая, кукурузная и первая овсяная. В составе этих кашек нет молока и сахара. Для роста и развития ребенка, кашки дополнительно обогащены 12 витаминами, 4 основными минералами, а также натуральными пищевыми волокнами - пребиотиками, полученными из цикория. Пищевые волокна служат субстратом для роста полезной микрофлоры, что способствует пищеварению, укреплению иммунитета и улучшает всасывание кальция. </p>
								<!-- Ряд ячеек -->
								<h2>Возраст 6+ месяцев</h2>
								<div class="img-right">
									<img src="http://www.heinz-baby.ru/images/products/NEW_M_OAT_PEACH.png" alt="">
								</div>
								<h3>Физиологические потребности (особенности) ребенка</h3>
								...
								<div class="article-inner-b">
									...
									<div class="img-right">
										<img src="http://www.heinz-baby.ru/images/products/new_Lak_Multi_apple-cher.png" alt="">
									</div>
									<h3>Рекомендуемый вид детской кашки Heinz</h3>
								...
								<!-- Ряд ячеек -->
								<h2>Возраст 12+ месяцев</h2>
								<div class="img-right">
									<img src="http://www.heinz-baby.ru/images/products/new_LUBO_banan-klub.png" alt="">
								</div>
								<h3>Физиологические потребности (особенности) ребенка</h3>

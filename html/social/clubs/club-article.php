...
<div class="layout-container">
	<div class="layout-wrapper">
		...
		<div class="content-cols clearfix">
			...
			<div class="col-23-middle ">
				...
				<div class="col-gray">
					<div class="b-article b-article__wide clearfix">
						<div class="b-article_cont">
							<div class="b-article_bg">
								<div class="b-article_header clearfix">
									...
									<div class="float-l">
										<a class="b-article_author" href="">Ангелина Богоявленская</a>
										<span class="b-article_date">Сегодня 13:25</span>
									</div>
									<!-- Блок настроек записи -->
									<!-- <div class="article-settings article-settings__float-r">
								...
								<div class="b-article_in clearfix">
									<div class="wysiwyg-content clearfix">
										<div class="b-article_in-img">
											<iframe width="680" height="375" frameborder="0" allowfullscreen="" src="http://www.youtube.com/embed/pehSAUTqjRs?wmode=transparent"></iframe>
										</div>
								...
								<div class="like-control like-control__circle clearfix">
									<!-- во всех блоках like-control можно заменить postion-rel на like-control_i -->
									<div class="like-control_i">
							...
							<div class="b-banners">
								<img src="/images/example/yandex-direct_wide.jpg" alt="">
							</div>
					...
					<div class="such-post">
						...
						<div class="such-post_i such-post_i__photopost">
							<a href="" class="such-post_img-hold">
								<img src="/images/example/w335-h230.jpg" alt="" class="such-post_img">
								<span class="such-post_img-overlay"></span>
								<span class="such-post_tip">50 фото</span>
							</a>
							<div class="such-post_type-hold">
								<div class="such-post_type such-post_type__photopost"></div>
							</div>
							<div class="such-post_cont">
								...
								<a href="" class="such-post_t">Креативная сервировка стола - 50 замечательных примеров</a>
							</div>
						</div>
					</div>

					<div class="such-post">
						<div class="such-post_i such-post_i__medium">
							<a href="" class="such-post_img-hold">
								<img src="/images/example/w220-h165-2.jpg" alt="" class="such-post_img">
							</a>
							<div class="such-post_type-hold">
							...
							<div class="such-post_cont">
								...
								<a href="" class="such-post_t">Самое лучшее утро - просыпаюсь, а ты рядом</a>
							</div>
						</div>
						<div class="such-post_i such-post_i__medium">
							<a href="" class="such-post_img-hold">
								<img src="/images/example/w220-h165-1.jpg" alt="" class="such-post_img">
							</a>
							<div class="such-post_type-hold">
								<div class="such-post_type such-post_type__post"></div>
							</div>
							<div class="such-post_cont">
								...
								<a href="" class="such-post_t">Печеньки</a>
							</div>
						</div>
						<div class="such-post_i such-post_i__medium">
							<a href="" class="such-post_img-hold">
							...
							<div class="such-post_type-hold">
								<div class="such-post_type such-post_type__video"></div>
							</div>
							<div class="such-post_cont">
								<div class="clearfix">
									<div class="float-l">
	...
	<!-- 				
	 ...
	 -->
					...
					<div class="b-article b-article__user-status b-article__wide clearfix">
						<div class="b-article_cont clearfix">
							<div class="b-article_bg">
								<div class="b-article_header clearfix">
									<div class="meta-gray">
									...
									<div class="float-l">
										<a class="b-article_author" href="">Ангелина Богоявленская</a> <br>
										<span class="b-article_date">Сегодня 13:25</span>
									</div>
								</div>
								<div class="b-article_in clearfix">

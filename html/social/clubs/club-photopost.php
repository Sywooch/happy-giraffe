                    ...
                    <div class="b-article_cont clearfix">
                        ...
                        <div class="b-article_in clearfix">
                            ...
                            <div class="margin-20 clearfix">
                                ...
                                <div class="float-l">
                                    <a href="" class="b-article_photo-control b-article_photo-control__single active powertip" title="Обложка"></a>
                                    <a href="" class="b-article_photo-control b-article_photo-control__grid powertip" title="Плитка"></a>
                                </div>
                            </div>
                        </div>

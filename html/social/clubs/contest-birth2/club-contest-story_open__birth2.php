					...
					<div class="col-23-middle clearfix">
						...
						<div class="clearfix">
							<ul class="b-section_ul b-section_ul__white clearfix">
								...
								<li class="b-section_li"><a class="b-section_li-a" href=""><img alt="" src="/images/contest/club/birth2/club-menu-btn.png"></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="col-23-middle">
				...
				<div class="b-contest-advert">
					<div class="b-contest-advert_ico">
						<img src="/images/contest/club/birth2/medium.png" alt="" class="b-contest-advert_img">
					</div>

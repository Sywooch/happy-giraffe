	...
	<div class="layout-wrapper">
		...
		<div class="layout-content margin-l0 clearfix">
			...
			<div class="col-white">
				...
				<div id="contest" class="contest-12">
					...
					<div class="contest-nav clearfix">
						<ul>
							...
							<li class="active"><a href="">Правила</a></li>
							<li><a href="">Призы</a></li>
							<li><a href="">Участники</a></li>
						</ul>
					</div>
					
					<div class="content-title">Правила фотоконкурса «Поделись улыбкою своей»</div>
				
					<div class="contest-rules">

						<h4>1. Общие правила проведения фотоконкурса «Поделись улыбкой своей»</h4>
						
						<p>1.1. Фотоконкурс «Поделись улыбкою своей» будет проведен с 14.11.2013 по 27.11.2013 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
						<p>1.2. Организаторами конкурса является <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a> совместно с торговой маркой SilverCare <a href="http://www.silver-care.ru">http://www.silver-care.ru</a> </p>
						<p>1.3. Участник Конкурса должен проживать на территории России, Украины, Беларуси или Казахстана.</p>
						<p>1.4. Все участники Конкурса должны полностью заполнить анкету.</p>
						<p>1.5. На конкурсном фото должен быть изображен улыбающийся ребенок. </p>
						...
						<p>2.2. Голосование предполагает возможность зарегистрированного или авторизованного через свою учетную запись социальной сети (“ВКонтакте”, “Одноклассники”) посетителя сайта <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a> отдать свой голос за наиболее понравившееся фото, участвующее в Конкурсе.</p>
						<p>2.4. Итоги Конкурса будут подведены 04.12.2013 г.</p>
						
						<h4>3. Права и обязанности Участников Конкурса</h4>
						
						<p>3.1. Для участия в Конкурсе необходимо быть зарегистрированным пользователем сайта <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>, и полностью заполнить анкету. Затем Участник может опубликовать конкурсную фотографию. Фотография должна соответствовать теме и условиям Конкурса.</p>
						...
						<ul>
							<li>- 1 место - Набор Silver Care из 7 предметов для всей семьи   <br></li>
							<li>- 2 место - Набор Silver Care из 5 предметов для всей семьи  <br></li>
							<li>- 3 место - Набор Silver Care из 4 предметов для всей семьи  <br></li>
						</ul>
						...
						<p>5.4. Информация о победителях будет опубликована на сайте 04.12.2013 г.</p>
						...
						<p>6.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>
						<br/>

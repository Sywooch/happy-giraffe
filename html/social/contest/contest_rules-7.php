...
<div class="layout-container">
	<div class="layout-wrapper">
		...
		<div id="content">
			<div id="contest" class="contest-7">
				...
				<div class="content-title">Правила фотоконкурса «В ожидании чуда»</div>
			
				<div class="contest-rules">
					
					<h4>1. Сроки проведения фотоконкурса «В ожидании чуда»</h4>
					...
					<ul>
						<li>- 1 место - Комод Chloe & Ryan «Жираф и Лев» <br></li>
						<li>- 2 место - Развивающий коврик  Felice «Теленок» <br></li>
						<li>- 3 место - Подогреватель Tigex детского питания Express Car Home <br></li>
					</ul>

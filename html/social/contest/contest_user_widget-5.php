					...
					<div class="col-23 clearfix">
						...
						<div class="clearfix">
							...
							<div class="col-3">
								...
								<div class="contest-advert contest-advert-5">
									<a href="#" class="contest-advert-btn">Принять участие!</a>
								</div>
								<!-- <br /> нужен для отбивки блока, только на тестовой странице -->
								<br /><br />
								...
								<div class="user-friends clearfix">
									...
									<div class="more-friends"><a href="">Найти еще друзей</a> <a href="" class="wannachat">Хочу общаться!</a></div>

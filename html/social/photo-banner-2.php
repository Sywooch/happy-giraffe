				...
				<div class="col-23-middle col-gray clearfix">
					...
					<div class="b-article clearfix">
						...
						<div class="b-article_cont clearfix">
							...
							<div class="b-article_album-header">
								Альбом  <a href="">Мои любимые мужчины</a> 25 фото из 52
							</div>
							<h2 class="b-article_t">
								Самое лучшее утро - ты рядом
							</h2>
							<div class="b-article_in clearfix">
								<div class="wysiwyg-content clearfix">
									<div class="b-article_in-img">
										<a href="">
										<img title="Убить Дракона. Фантасмагория или сказка для взрослых. фото 1" src="http://img.happy-giraffe.ru/thumbs/580x1100/10/6921fcaad774db4e5ae538f9195e3928.jpg" class="content-img" alt="Убить Дракона. Фантасмагория или сказка для взрослых. фото 1" width="800">
										<span class="b-article_in-img-overlay">
											<span class="b-article_in-img-zoom powertip"></span>
										</span>
										</a>
									</div>
									<div class="b-article_in-img-desc">Я не нашел, где можно поменять название трека. Меняя название трека в альбоме он автоматически производит поиск по сайту и подцепляет естественно студийные версии песен вместо нужных.  я не нашел, где можно поменять название трека. Меняя название трека в альбоме он автоматически </div>
								</div>

								<div class="photo-preview-row clearfix">
					            	<div class="textalign-l clearfix">
					            		<span class="photo-preview-row_t-small">Другие фотографии альбома</span>
					            	</div>
					                <div class="photo-preview-row_hold">
						                ...
						                <div class="photo-preview-row_last">
					                        ...
					                        <a class="photo-preview-row_a" href="">56054</a>
					                    </div>
					                </div>
					            </div>
							</div>

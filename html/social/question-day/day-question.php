		...
		<div class="content-cols clearfix">
			...
			<div class="col-23-middle">
				...
				<div class="question-day">
					<div class="question-day_t">
						<span class="question-day_t-ico"></span>Вопрос дня
					</div>
					<div class="question-day_tx">«Как вы справлялись, когда у вашего ребенка резались зубки?»</div>

					<div class="question-day_proffer clearfix">
						
							<div class="float-r">
								<a href="" class="question-day_proffer-noanswer">У меня нет ответа</a>
								<a href="" class="btn-blue btn-h46">Ответить</a>
							</div>
							<div class="float-l">
								<div class="b-ball-add">
									<div class="b-ball-add_tx">
										За  ответ вам будет <br> начислено
									</div>
									<div class="b-ball-add_count">
										<div class="b-ball-add_count-num">20</div>
										баллов
									</div>
								</div>
							</div>
				...
				<div class="question-day">
					...
					<div class="question-day_answer">
						<div class="question-day_answer-arrow"></div>
						
						<div class="wysiwyg-v wysiwyg-blue clearfix">

<!-- WYSIWYG такой же как при добавлении статьи -->
...
$(document).ready(function () { 
  $('.wysiwyg-redactor-v').redactor({
      ...
      minHeight: 410,
      autoresize: true,
      toolbarExternal: '.wysiwyg-toolbar-btn-v',
              ...
              callback: function(buttonName, buttonDOM, buttonObject) {
                  ...
                  var html = this.get();
							...
							<div class="wysiwyg-toolbar">
								<div class="wysiwyg-toolbar-btn-v"></div>
							</div>
							<textarea name="" class="wysiwyg-redactor-v" placeholder="Введите ваш ответ"></textarea>
						</div>

						<div class="clearfix margin-t15">
							<div class="float-r">

	...
	<div class="layout-wrapper">
		...
		<div class="content-cols clearfix">
			...
			<div class="col-23-middle">
				...
				<div class="b-article b-article__day-answer clearfix">
					<div class="float-l">
					...
					<div class="b-article_cont clearfix">
						...
						<div class="question-day-art">
							<div class="question-day-art_t">
								<span class="question-day-art_t-ico"></span>Вопрос дня
							</div>
							<div class="question-day-art_tx">«Как вы справлялись, когда у вашего ребенка резались зубки?»</div>
						</div>

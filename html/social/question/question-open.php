	...
	<div class="layout-content clearfix">
			...
			<div class="col-23-middle">
				<div class="user-add-record user-add-record__small clearfix">
					...
					<div class="user-add-record_hold">
						...
						<a href="#popup-user-add-question"  data-theme="transparent" class="user-add-record_ico user-add-record_ico__question fancy powertip" title="Задать вопрос"></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="content-cols clearfix">
			...
			<div class="col-23-middle">
				...
				<div class="b-article b-article__question clearfix">
					<div class="float-l">
				...
				<div class="article-banner">
					<a href="">
						<img border="0" src="/images/example/yandex-direct_wide.jpg" alt="" title="">
					</a>
				</div>

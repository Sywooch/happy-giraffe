			...
			<div class="content-cols clearfix">
				<div class="col-1">
					...
					<div class="menu-list menu-list__favorites">
						...
						<a href="" class="menu-list_i menu-list_i__master active">
							<span class="menu-list_ico"></span>
							<span class="menu-list_tx">Мастер классы</span>
							<span class="menu-list_count">685</span>
						</a>
						<a href="" class="menu-list_i menu-list_i__cook active">
							<span class="menu-list_ico"></span>
				...
				<div class="col-23 clearfix">
					...
					favorites-search__found - при осуществленном поиске
					  -->
					<div class="favorites-search clearfix favorites-search__found">
						<div class="favorites-search_hold clearfix">
							<input type="text" name="" id="" class="favorites-search_itx ui-autocomplete-input" placeholder="Введите слово или тег">
							<!-- 
							В начале ввода текста добавить класс active
							 -->
							<button class="favorites-search_btn"></button>
						</div>
						...
						<div class="entry">
							...
							<div class="entry-header">
								<div class="entry-title_hold">
									<a href="" class="entry-title">Альбом «Оформление вторые блюда» - 3 фото </a>
								</div>
					...
					<div class="entry-hold">
						<div class="entry">
							...
							<div class="entry-header">
								<div class="entry-title_hold">
									<a href="" class="entry-title">Необычная свадьба в народном стиле с байкерами</a>
								</div>
									...
									<div class="favorites-control">
										...
										<div class="favorites-add-popup">
											...
											<div class="favorites-add-popup_row">
												...
												<span class="favorites-add-popup_tag">
													<a href="" class="favorites-add-popup_tag-a">Красноперка</a>
													<a href="" class="ico-close"></a>
												</span>
											</div>
											<!-- <div class="favorites-add-popup_row margin-b10">

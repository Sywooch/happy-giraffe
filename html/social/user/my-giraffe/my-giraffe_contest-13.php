			...
			<div class="col-1">
				...
				<div class="contest-tizer contest-tizer__13 clearfix">
					...
					<div class="contest-tizer_hold">
						...
						<a class="contest-tizer_a" href="">Моя любимая игрушка</a>
					</div>
				</div>
			</div>
			<div class="col-23-middle col-gray">

				<div class="b-article-conversion b-article-conversion__contest b-article-conversion__13">
							...
							<div class="fast-articles2 ">
								<div class="fast-articles2_i">
									<div class="fast-articles2_header clearfix">
										...
										<a class="ava-name" href="">Марина</a>
									</div>

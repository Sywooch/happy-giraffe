				...
				<div class="col-gray">
					<div class="user-notice clearfix">
						<div class="user-notice_t-hold clearfix">
							...
							<a href="" class="user-notice_mark-all btn-blue">Отметить все как прочитанные</a>
						</div>
						...
						<div class="user-notice-list">
							<div class="user-notice-list_i">
								<div class="user-notice-list_i-hold">
									<div class="user-notice-list_deed">
										...
										<a href="" class="user-notice-list_a-big">127</a>
									</div>
									<div class="user-notice-list_desc">
										Сегодня, 13:25 <br>  Новых комментариев
									</div>
									<!-- 
									Варианты цвета в подсказке color-category, такие же как и категории клубов
									kids
									manwoman
									beauty
									home
							...
							<div class="user-notice-list_i">
								<div class="user-notice-list_i-hold">
									<div class="user-notice-list_deed">
										<span class="user-notice_ico user-notice_ico__comment"></span>
										<a href="" class="user-notice-list_a-big">7</a>
									</div>
									<div class="user-notice-list_desc">
										Сегодня, 13:25 <br>  Новых комментариев
									</div>
							...
							<div id="infscr-loading"><img alt="Loading..." src="/images/ico/ajax-loader.gif" /><div>Загрузка ранних уведомлений</div></div>
						</div>
					</div>
				</div>
				</div>

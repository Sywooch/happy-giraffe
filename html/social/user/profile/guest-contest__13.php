			...
			<div class="section-lilac_hold">
				<div class="section-lilac_left">
                    ...
                    <div class="user-btns clearfix">
                    	...
                    	<a href="" class="user-btns_i powertip" title="Написать сообщение">
                    	...
                    	<a href="" class="user-btns_i powertip" title="Смотреть блог">
                    		<span class="user-btns_ico-hold user-btns_ico-hold__blog">
                    			<span class="user-btns_ico"></span>
                    		</span>
                    		<span class="user-btns_tx">158 <br> записей</span>
                    	</a>
                    	<a href="" class="user-btns_i powertip" title="Смотреть фотографии">
                    		<span class="user-btns_ico-hold user-btns_ico-hold__photo ">
                    			<span class="user-btns_ico"></span>
                    		</span>
                    		<span class="user-btns_tx">365 <br> фото</span>
                    	</a>
                    </div>
				</div>
		...
		<div class="content-cols clearfix">
			<div class="col-1">
				...
				<div class="widget-friends clearfix">
					<div class="clearfix">
						<span class="heading-small">Мои друзья <span class="color-gray">(16)</span> </span>
						<a href="" class="padding-l20">Все друзья</a>
					</div>
    ...
    $('.b-interest_li').bind({
    	...
    	mouseout: function(){
    		$(this).find('.b-interest_popup').stop(true, true).delay(200).fadeOut(200);
                ...
                <!-- конкурс -->
				<div class="b-article-conversion b-article-conversion__contest b-article-conversion__13 b-article-conversion__13-2">
					...
					<div class="textalign-c">
							...
							<div class="b-article-prev_cont clearfix">
								...
								<div class="b-article-prev_in">
									<div class="b-article_in-img">
										<!-- img width 235px -->
										<img alt="Ночные гости - кто они фото 1" class="content-img" src="http://img.happy-giraffe.ru/thumbs/235x/181065/b612459ad8c7be99bbb89f7c49db2906.jpeg" title="Ночные гости - кто они фото 1">
									</div>
								</div>
							</div>
						</div>
						<div class="b-article-conversion_crosshead">
							<div class="b-article-conversion_crosshead-top">
								<a href="" class="b-article-conversion_crosshead-logo">
									<img src="/images/contest/b-article-conversion__13_crosshead-logo.png" alt="">
								</a>
							</div>

				...
				<div class="section-lilac_right">
					<div class="b-family b-family__bg">
						...
						<ul class="b-family_ul">
							...
							<li class="b-family_li">
								<div class="b-family_img-hold">
									<a href="" class="b-family_more">еще 3</a>
								</div>
								<div class="b-family_tx">
								</div>
							</li>
			...
			<div class="col-23-middle">
				...
				<div class="about-self">
					...
					<div class="about-self_ctn">
						<textarea name="" id="" cols="30" rows="3" class="about-self_textarea" placeholder="Введите текст"></textarea>
						<div class="clearfix">
							<a href="" class="btn-blue margin-r10">Добавить</a>

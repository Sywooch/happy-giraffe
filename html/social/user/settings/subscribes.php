				...
				<div class="col-23-middle clearfix">
	                ...
	                <div class="col-gray"> 
						<ul class="cont-nav textalign-l">
							...
							<li class="cont-nav_i active">
								<a class="cont-nav_a" href="">Рассылки </a>
							</li>
						</ul>
						...
						<div class="form-settings">
							<div class="form-settings_label-row clearfix">
								<div class="form-settings_label form-settings_label__long">
									Ежедневная рассылка о новом о сайте
								</div>
							...
							<div class="form-settings_label-row clearfix">
								<div class="form-settings_label form-settings_label__long">
									Новые комментарии к вашим записям, фото, видео
								</div>
								<div class="display-ib">
									<a href="" class="a-checkbox active"></a>
								</div>
							...
							<div class="form-settings_label-row clearfix">
								<div class="form-settings_label form-settings_label__long">
									Новые ответы на ваш комментарий
								</div>
								<div class="display-ib">
									<a href="" class="a-checkbox active"></a>
								</div>
							...
							<div class="form-settings_label-row clearfix">
								<div class="form-settings_label form-settings_label__long">
									Новые ответы на заданый вами вопрос
								</div>
								<div class="display-ib">
									<a href="" class="a-checkbox active"></a>
								</div>
							...
							<div class="form-settings_label-row clearfix">
								<div class="form-settings_label form-settings_label__long">
									Новые комментарии к записи в обсуждении которой вы принимали участие
								</div>
								<div class="display-ib">
									<a href="" class="a-checkbox active"></a>
								</div>

    ...
    <div class="layout-wrapper">
        ...
        <div class="content-cols clearfix">
            <div class="col-1">
                <div class="b-ava-large">
                    <div class="b-ava-large_ava-hold clearfix">
                        ...
                        <a href="" class="b-ava-large_bubble b-ava-large_bubble__friend powertip" title="Добавить в друзья">
            ...
            <div class="col-23-middle col-gray">
                ...
                <div class="b-article b-article__photopost b-article__wide clearfix">
                    <div class="b-article_cont clearfix">
                        <div class="b-article_bg">
                            <div class="b-article_header clearfix">
                                ...
                                <a href="#photo-widget" class="add-photo-widget powertip fancy add-photo-widget__float-r" title="Создать виджет"></a>
                            </div>
                                ...
                                <div class="photo-grid clearfix">
                                    <div class="photo-grid_row clearfix" >
                                        ...
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/w680-h450.jpg" alt="">
                            ...
                            <div class="b-article_in clearfix">
                                ...
                                <div class="photo-grid clearfix">
                                    <div class="photo-grid_row clearfix" >
                                        <!-- Ловить клик на photo-grid_i для показа увеличенного фото -->
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-18.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-17.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-16.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="photo-grid_row clearfix" >
                                        <!-- Ловить клик на photo-grid_i для показа увеличенного фото -->
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-19.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-20.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-21.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                        <div class="photo-grid_i">
                                            <img class="photo-grid_img" src="/images/example/photo-grid-22.jpg" alt="">
                                            <div class="photo-grid_overlay">
                                                <span class="photo-grid_zoom"></span>
                                            </div>
                                        </div>
                                ...
                                <div class="margin-20 clearfix">
                                    <a href="" class="float-r btn-blue-light btn-medium">Смотреть галерею</a>
                                    <div class="float-l">
                                        <a href="" class="b-article_photo-control b-article_photo-control__single"></a>
                                        <a href="" class="b-article_photo-control b-article_photo-control__grid active"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-likes-b">

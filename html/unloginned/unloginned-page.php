...
<body class="body-gray theme theme__adfox">
            ...
            <div class="header-banner">
              <div class="header-banner_hold">
                <!-- Сам баннер -->
                <embed width="680" height="345" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="http://content.adfox.ru/140919/adfox/413968/1104569.swf" play="true" loop="true" menu="true">
    	...
    	<div class="layout-header clearfix">
            ...
            <header class="header header__guest header__kinder-gold">
              <div class="header_hold clearfix">
                ...
                <div class="header-ad-kinderino header-ad-kinderino__guest"><a href="#">
                <!-- header_kindergold.jpgheader_kinderino.jpg
                --><img src="/lite/images/banner/header_kinderino-2.gif" alt="Kinder"><span onmouseover="this.style.backgroundPosition='0 -20px'" onmouseout="this.style.backgroundPosition='0 0'" style="background-position: 0px 0px;"></span></a></div>

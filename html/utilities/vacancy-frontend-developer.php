...
<body class="body-gray body__vacancy">
...
<div class="layout-container">
	<div class="layout-wrapper">
		...
		<div class="vacancy clearfix">
			...
			<div class="requirements requirements__frontend clearfix">
				<!-- ### -->
				<h1 class="requirements_title">НАМ НУЖЕН Frontend-разработчик</h1>
				<!-- ### -->
				<div class="requirements_title-sub">У нас красивый и просторный офис в Ярославле - в здании Петровского Пассажа  </div>
				<!-- ### -->
				<div class="requirements_func">var js = function() { return rez; }</div>
				<div class="requirements_hold clearfix">
					<div class="requirements_col-l">
						...
						<!-- ### -->
						<div class="requirements_pay-2"></div>
					</div>
					<div class="requirements_col-r">
						...
						<div class="requirements_desc">
							...
							<!-- ### -->
							<div class="requirements_skils-2"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="vacancy_row vacancy_row__blue">
				...
				<div class="vacancy_row-desc">
					<ul class="vacancy_ul">
						<!-- ### -->
						<li class="vacancy_li">Вас ждет разработка интерактивного UI и одностраничных приложений на knockout.js</li>
						...
						<li class="vacancy_li">Вы с радостью внедрим классную технологию, предложенную кандидатом</li>
			...
			<div class="vacancy_row vacancy_row__carrot">
				...
				<div class="vacancy_row-desc">
					<ul class="vacancy_ul">
						...
						<li class="vacancy_li">Работать c git</li>
					</ul>
				</div>
			</div>
			<!-- ### -->

				...
				<div class="b-avacancy">
					...
					<div class="margin-b40">
						...
						<ul class="list-simple">
							<li class="list-simple_li">уверенное знание PHP5, ОПП, паттернов проектирования;</li>
							<li class="list-simple_li">опыт работы с фреймворком Yii;</li>
							<li class="list-simple_li">достаточный уровень знаний смежных технологий (js/jquery/ajax, html/css); </li>
							<li class="list-simple_li">опыт работы с системами контроля версий (git);</li>
							<li class="list-simple_li">опыт работы с linux на уровне пользователя.</li>
					...
					<div class="margin-b40">
						...
						<ul class="list-simple">
							<li class="list-simple_li">опыт работы с MongoDB и/или другими NoSQL-решениями; </li>
							<li class="list-simple_li">опыт работы с Comet-сервером;</li>
							<li class="list-simple_li">опыт работы с backbone.js, knockout.js или подобными;</li>
							<li class="list-simple_li">опыт разработки высоконагруженных систем.</li>
						</ul>
					</div>
					...
					<div class="vote-vacancy">
						...
						<div class="vote-vacancy_q">
							...
							<div class="vote-vacancy_r">
								...
								<textarea name="" id="" cols="30" rows="10" class="itx-gray"></textarea>
							</div>
						</div>
						<div class="vote-vacancy_q">
							<div class="vote-vacancy_l">
						...
						<div class="vote-vacancy_q">
							...
							<div class="vote-vacancy_r">
								<div class="vote-vacancy_desc">
									<p>Есть фотогалерея, написанная на js. Список фото хранится в массиве. При перелистывании вперед или назад, необходимо подгрузить изображения n следующих/предыдущих фото, относительно текущей. Фотогалерея - лишь абстракция, необходимая для более понятного объяснения задачи. Напишите функцию, которая будет принимать следующие аргументы: массив, индекс текущего элемента в массиве, количество следующих или предыдущих элементов, которые необходимо выбрать. </p>
									<p>Пример кода:</p>

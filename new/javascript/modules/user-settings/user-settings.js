define(['jquery', 'knockout', 'text!user-settings/user-settings.html', 'models/User', 'models/Geography', 'extensions/SocialNetworks', 'knockout.mapping', 'common'], function userSettingsHandler($, ko, template, User, Geography, SocialNetworks) {

...
/**
 * копипаст ElasticEmail и смена конфига
 * Author: crocodile
 * Date: 26.05.16
 */
class ElasticEmailTransactional extends CApplicationComponent
{

    const USERNAME = 'happy-giraffe-transactional@yandex.ru';
    const KEY = '5a10e5ef-c005-45e6-8eaa-3f2d63bc2a09';
    ...
    public static function sendCampaign($body, $list = null, $segment = null, $template = 'weekly_news', $subject = null)
    {
        $res = "";

...
ALTER TABLE  `user` ADD FOREIGN KEY user_country_fk (  `country_id` ) REFERENCES  `geo_country` (
`id`
) ON DELETE SET NULL ON UPDATE SET NULL ;

ALTER TABLE  `user` DROP FOREIGN KEY `user_settlement_fk` ;

ALTER TABLE  `user` ADD FOREIGN KEY  user_settlement_fk  ( `settlement_id` ) REFERENCES  `geo_rus_settlement` (
`id`
) ON DELETE SET NULL ON UPDATE SET NULL ;

ALTER TABLE  `user` DROP FOREIGN KEY  `user_street_fk` ;

ALTER TABLE  `user` ADD FOREIGN KEY user_street_fk (  `street_id` ) REFERENCES  `geo_rus_street` (
`id`
) ON DELETE SET NULL ON UPDATE SET NULL ;

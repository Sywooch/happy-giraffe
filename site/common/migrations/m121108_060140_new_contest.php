...
class m121108_060140_new_contest extends CDbMigration
{
	public function up()
	{
        $this->execute('INSERT INTO `happy_giraffe`.`contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`) VALUES (NULL, \'Поделись улыбкою своей\', \'<p>Больше всего на свете Веселый Жираф любит радостные лица людей, особенно — маленьких. А потому приглашает вас принять участие в новом фотоконкурсе - «Поделись улыбкою своей!»</p>
<p>Покажите, как ваш ребенок улыбается всему миру! Пусть светлые детские улыбки осветят наши серые будни и сделают жизнь радостней! А герои тех фотографий, которые найдут отклик в сердцах наибольшего количества людей, получат приятные и полезные призы.</p>\', \'\', \'<h4>1. Сроки проведения фотоконкурса “Поделись улыбкою своей”</h4>

					<p>1.1. Фотоконкурс “Поделись улыбкою своей” будет проведен с 8.11.2012 по 21.11.2012 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
					...
					<p>3.4. Итоги Конкурса будут подведены  28.11.2012 г.</p>
					...
					<ul>
						<li>псотрудники и представители Организатора;</li>
					...
					<ul>
						<li>1 место – Full HD-видеокамера Samsung HMX-Q10 <br></li>
						<li>2 - 5 место – настольные игры (одна из игр «Монополия»,«Имаджинариум», «Скажи иначе», настольный футбол) <br></li>
					</ul>
					...
					<p>6.4. Информация о победителях будет опубликована на сайте 28.11.2012 г.</p>
					...
					<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>\', \'2012-11-08\', \'2012-11-21\', \'1\');
');
	}

	public function down()
	{
		echo "m121108_060140_new_contest does not support migration down.\n";
		return false;
	}

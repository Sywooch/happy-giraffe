...
class m121108_081617_fix_contest_rules extends CDbMigration
{
	public function up()
	{

        $sql = <<<EOD
<h4>1. Сроки проведения фотоконкурса “Поделись улыбкою своей”</h4>
...
<p>6.2. Победителями станут 5 (пять) Участников, решение о победителях принимает экспертное жюри по результатам голосования зарегистрированных пользователей сайта <a href="#">http://www.happy-giraffe.ru</a>.</p>
...
EOD;
        $this->execute('UPDATE contest__contests SET rules = \''.$sql.'\' WHERE id = 3;');
	}

	public function down()
	{
		echo "m121108_081617_fix_contest_rules does not support migration down.\n";
		return false;
	}

...
class m121203_052610_contest_5 extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
INSERT INTO `happy_giraffe`.`contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`, `last_updated`) VALUES (NULL, 'Сладкий сон', '<p>Есть поговорка: «Хочешь увидеть ангела — взгляни на спящего младенца». Действительно, спящий ребенок такой милый и беззащитный... </p>
<p>Давайте посмотрим, как спят наши детки! Весёлый Жираф предлагает всем желающим принять участие в конкурсе «Сладкий сон». Для этого разместите фотографию вашего спящего ребенка на нашем сайте, пригласите всех своих знакомых полюбоваться им  и отдать свой голос именно за вашего спящего ангелочка!  И, что самое приятное —  победители конкурса получат   замечательные призы, которые пригодятся  каждому!</p>', '', '<h4>1. Сроки проведения фотоконкурса «Сладкий сон»</h4>

<p>1.1. Фотоконкурс «Сладкий сон» будет проведен с 3.12.2012 по 14.12.2012 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>3.4. Итоги Конкурса будут подведены 21.12.2012 г.</p>
...
<ul>
    <li>1 место - Увлажнитель воздуха Tigex (Франция) Programmable <br></li>
    <li>2-3 место - Радионяня Я расту WT-448 <br></li>
</ul>
...
<p>6.4. Информация о победителях будет опубликована на сайте 21.12.2012 г.</p>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', '2012-12-03', '2012-12-14', '1', NULL);
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m121203_052610_contest_5 does not support migration down.\n";
		return false;
	}

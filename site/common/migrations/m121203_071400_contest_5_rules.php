...
class m121203_071400_contest_5_rules extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
UPDATE `happy_giraffe`.`contest__contests` SET `rules` = '<h4>1. Сроки проведения фотоконкурса «Сладкий сон»</h4>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', `last_updated` = NOW() WHERE `contest__contests`.`id` = 5;
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m121203_071400_contest_5_rules does not support migration down.\n";
		return false;
	}

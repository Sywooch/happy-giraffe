...
class m121208_113510_rules extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
UPDATE `happy_giraffe`.`contest__contests` SET `rules` = '<h4>1. Сроки проведения фотоконкурса “Веселые брызги”</h4>

<p>1.1. Фотоконкурс “Веселые брызги” будет проведен с 19.11.2012 по 30.11.2012 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>3.4. Итоги Конкурса будут подведены 10.12.2012 в 18:00.</p>
...
<ul>
    <li>1 место - Детский надувной бассейн Intex «Easy Set» <br></li>
    <li>2 место - Детский надувной бассейн Intex «Easy Setk» <br></li>
    <li>3 место - Детский надувной бассейн Intex «Жираф» <br></li>
    <li>4 - 5 место - Термометр Avent Philips Авент Филипс SCH 550/20 для воды и воздуха <br></li>
</ul>
...
<p>6.4. Информация о победителях будет опубликована на сайте 10.12.2012 в 18:00.</p>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>' WHERE `contest__contests`.`id` = 4;
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m121208_113510_rules does not support migration down.\n";
		return false;
	}

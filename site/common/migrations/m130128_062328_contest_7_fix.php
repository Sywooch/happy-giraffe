...
class m130128_062328_contest_7_fix extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
INSERT INTO `contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`, `last_updated`) VALUES (NULL, 'В ожидании чуда', '<p>Беременность – это всегда волнительный, но такой радостный для каждой женщины период. А время от двух полосочек на тесте до сбора сумок в роддом, пролетает так быстро! И, конечно же, его нужно запечатлеть! </p>

<p>Поделитесь с нами фото, когда вы носили под сердцем своего кроху. Примите участие в новом конкурсе  “В ожидании чуда” и получите полезные призы!</p>', '', '<h4>1. Сроки проведения фотоконкурса «В ожидании чуда»</h4>

<p>1.1. Фотоконкурс «В ожидании чуда» будет проведен с 28.01.2013 по 8.02.2013 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>2.3. На конкурсном фото должны быть изображены вы (для женщин) или ваша жена (для мужчин).</p>
...
<p>3.4. Итоги Конкурса будут подведены 15.02.2013 г.</p>
...
<p>4.2. Пользователь может разместить только одну фотографию на Конкурсарс.</p>
...
<ul>
    <li>- 1 место - Комод для детских вещей Chloe &amp; Ryan <br></li>
    <li>- 2 место - Развивающий коврик для малышей Felice <br></li>
    <li>- 3 место - Подогреватель для детского питания Tigex <br></li>
</ul>
...
<p>6.4. Информация о победителях будет опубликована на сайте 15.02.2013 г.</p>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', '2013-01-28', '2013-02-08', '1', NOW());
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m130128_062328_contest_7_fix does not support migration down.\n";
		return false;
	}

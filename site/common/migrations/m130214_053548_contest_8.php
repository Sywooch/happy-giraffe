...
class m130214_053548_contest_8 extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
INSERT INTO `hg`.`contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`, `last_updated`) VALUES (NULL, 'Смешные малыши', 'Дети – это сплошной источник позитива, радости и веселья. Это настоящие маленькие артисты, которые умудряются вытворять невероятно забавные штуки и корчить смешные рожицы, от которых невозможно не улыбнуться! Поделитесь самой забавной фотографией вашего крохи и получите отличные призы в обмен на положительные эмоции!', '', '<h4>1. Сроки проведения фотоконкурса «Смешные малыши»</h4>

<p>1.1. Фотоконкурс «В ожидании чуда» будет проведен с 14.02.2013 по 1.03.2013 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', '2013-02-14', '2013-03-01', '0', NOW());
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m130214_053548_contest_8 does not support migration down.\n";
		return false;
	}

...
class m130512_143026_contest_10 extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
INSERT INTO `hg`.`contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`, `last_updated`) VALUES (NULL, 'Мой друг', '<p>У каждого ребенка есть любимая игрушка, которая становится его первым другом! Плюшевый мишка или забавный зайчонок становится полноправным членом семьи - с ним малыш гуляет, кушает, доверяет свои детские тайны, и засыпает, крепко прижав друга к себе.  </p>
<p>Присылайте фото своего малыша с первым другом и получайте замечательные призы, которые очень понравятся вашему ребенку!</p>', '', '<h4>1. Общие правила проведения фотоконкурса «Мой друг»</h4>
...
<p>2.4. Итоги Конкурса будут подведены 1.06.2013 г.</p>
...
<ul>
    <li>- 1-3 место - комфортер Cuski  <br></li>
</ul>
...
<p>5.4. Информация о победителях будет опубликована на сайте 1.06.2013 г.</p>
...
<p>6.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', '2013-05-13', '2013-05-27', '0', NOW());
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m130512_143026_contest_10 does not support migration down.\n";
		return false;
	}

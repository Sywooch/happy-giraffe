...
class m130830_111613_family extends CDbMigration
{
	public function up()
	{
        $this->execute("ALTER TABLE `user__users_partners` ADD `main_photo_id` INT(11)  UNSIGNED  NULL  DEFAULT NULL;");
        ...
        $this->execute("ALTER TABLE `user__users_babies` ADD `main_photo_id` INT(11)  UNSIGNED  NULL  DEFAULT NULL;");
        ...
        $this->execute("ALTER TABLE `users` ADD `main_photo_id` INT(11)  UNSIGNED  NULL  DEFAULT NULL;");
        $this->execute("ALTER TABLE `users` ADD INDEX `Photo` (`main_photo_id`);");
        $this->execute("ALTER TABLE `users` ADD FOREIGN KEY (`main_photo_id`) REFERENCES `album__photos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;");
	}

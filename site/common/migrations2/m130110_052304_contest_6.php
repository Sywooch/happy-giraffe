...
class m130110_052304_contest_6 extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
INSERT INTO `contest__contests` (`id`, `title`, `text`, `results_text`, `rules`, `from_time`, `till_time`, `status`, `last_updated`) VALUES ('6', 'Кроха кушает', '<p>Кормление малыша - это увлекательная игра, полная забавных моментов. И невозможно удержаться, чтобы их не сфотографировать!</p>
<p>А у вас есть забавные фото вашего ребенка, на которых он ест? Скорее присылайте их на наш новый фотоконкурс “Кроха кушает”, и выигрывайте полезные призы!</p>', '', '<h4>1. Сроки проведения фотоконкурса «Кроха кушает»</h4>

<p>1.1. Фотоконкурс «Сладкий сон» будет проведен с 10.01.2013 по 23.01.2013 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>7.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>', '2013-01-10', '2013-01-23', '0', NOW());
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m130110_052304_contest_6 does not support migration down.\n";
		return false;
	}

...
<p>Ваш малыш сделал первые шаги или нарисовал свой первый рисунок? А может быть, он делает успехи в спорте или раннем развитии? Поделитесь с нами этими выдающимися фото и выиграйте замечательные призы от партнера конкурса - компании Heinz! </p>', `rules` = '<h4>1. Общие правила проведения фотоконкурса «Первые достижения маленьких гениев и чемпионов»</h4>

<p>1.1. Фотоконкурс «Первые достижения маленьких гениев и чемпионов» будет проведен с 11.03.2013 по 22.03.2013 г. на сайте <a href="http://www.happy-giraffe.ru">http://www.happy-giraffe.ru</a>.</p>
...
<p>2.4. Итоги Конкурса будут подведены 29.03.2013 г.</p>
...
<p>5.4. Информация о победителях будет опубликована на сайте 29.03.2013 г.</p>
...
<p>6.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>' WHERE `contest__contests`.`id` = 9;
EOD;
        $this->execute($sql);

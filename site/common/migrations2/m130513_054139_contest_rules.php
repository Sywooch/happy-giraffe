...
class m130513_054139_contest_rules extends CDbMigration
{
	public function up()
	{
        $sql = <<<EOD
UPDATE `contest__contests` SET `rules` = '<h4>1. Общие правила проведения фотоконкурса «Мой друг»</h4>
...
<p>6.2. Организатор Конкурса гарантирует использование полученных им данных Участников только по прямому назначению, в соответствии с правилами проведения Конкурса.</p>' WHERE `contest__contests`.`id` = 10;
EOD;
        $this->execute($sql);
	}
	...
	{
		echo "m130513_054139_contest_rules does not support migration down.\n";
		return false;
	}

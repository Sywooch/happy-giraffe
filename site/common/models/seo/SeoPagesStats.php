...
/**
 * This is the model class for table "seo__pages_stats".
 *
 * The followings are the available columns in table 'seo__pages_stats':
 * @property string $id
...
class SeoPagesStats extends HActiveRecord
{
	 ...
	 * @return SeoPagesStats the static model class
	 */

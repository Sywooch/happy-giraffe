                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?=$activation_url?>" style="color: #0e72ed;font-size: 22px; " target="_blank">Зайти на сайт</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  height="25" style="">
                                            ...
                                            <tr>
                                                <td valign="top" style="border: 1px solid #e0d8f5; background: #eae4f9; padding: 15px 20px;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                                                        ...
                                                        <tr>
                                                            <td style="color: #999">
                                                                Сохраните свои учетные данные. Вы можете <a href="<?=$change_password_url?>" style="color: #0e72ed;" target="_blank">изменить пароль</a> в Настройках своего профиля.
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                                            ...
                                            <tr>
                                                <td style="font:13px arial, helvetica, sans-serif;color:#232323;line-height:16px;">
                                                    ...
                                                    <span style="color: #3587ec;"><a href="<?=$activation_url?>" target="_blank" style="color: #3587ec;">Веселый Жираф</a></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="border-top:1px solid #e6e5e5;padding:6px 0;">
                                                    ...
                                                    <p style="font:10px tahoma, arial, sans-serif; color: #979696;">Это письмо было сгенерированно автоматически. Пожалуйста не отвечайте на него. Если вы хотите обратиться в службу поддержки сайта «Веселый Жираф», напишите нам по адресу <span style=" color: #3587ec;"><a href="mailto:support@happy-giraffe.ru" target="_blank" style="color: #3587ec;">support@happy-giraffe.ru</a></span></p>

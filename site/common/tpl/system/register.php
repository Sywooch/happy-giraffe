                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?=$activation_url?>" style="color: #0e72ed;font-size: 22px; ">Зайти на сайт</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  height="25" style="">
                                            ...
                                            <tr>
                                                <td valign="top" style="border: 1px solid #e0d8f5; background: #eae4f9; padding: 15px 20px;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                                                        ...
                                                        <tr>
                                                            <td style="color: #999">
                                                                Сохраните свои учетные данные. Вы можете <a href="" style="color: #0e72ed;">изменить пароль</a> в Настройках своего профиля.
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>

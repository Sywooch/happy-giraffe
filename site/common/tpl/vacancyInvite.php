...
<head>
    ...
    <title><?=$firstName?>, мы ищем web-разработчика</title>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding: 0 20px;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="color: #666666; font-size: 16px;">Здравствуйте, <?=$firstName?>!</td>
                                                <td rowspan="12">
                                                    <img src="http://www.happy-giraffe.ru/new/images/mail/vacancy-man.jpg" alt="" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color: #333333; font-size: 22px;">Мы ищем супер web-разработчика в просторный офис в центре Ярославля. </td>
                                            </tr>
                                            <tr>
                                                <td  height="10" style="">
                                                    <img src="http://www.happy-giraffe.ru/images/mail/blank.gif" height="10" width="100%" border="0" />
                                            ...
                                            <tr>
                                                <td style="color: #666666; font-size: 16px;">Мы бы хотели видеть человека с развитыми навыками: </td>
                                            </tr>
                                            <tr>
                                                <td  height="15" style="">
                                            ...
                                            <tr>
                                                <td style="color: #333333; font-size: 20px;">
                                                    <ul style="margin:0;">
                                                        <li style="padding-bottom: 5px;">PHP </li>
                                                        <li style="padding-bottom: 5px;">JavaScript </li>
                                                        <li style="padding-bottom: 5px;">командной работы </li>
                                                        <li style="padding-bottom: 5px;">работы в Linux.</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="color: #666666; font-size: 16px;">И, самое главное, огромным желанием изменить мир!</td>
                                            </tr>
                                            <tr>
                                                <td  height="2" style="">
                                                    <img src="http://www.happy-giraffe.ru/images/mail/blank.gif" height="2" width="100%" border="0" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color: #666666; font-size: 16px;">Если это ты, то мы ждем тебя!</td>
                                            </tr>
                                            <tr>
                                                <td  height="25" style="">
                                                    <img src="http://www.happy-giraffe.ru/images/mail/blank.gif" height="25" width="100%" border="0" />
                                            ...
                                            <tr>
                                                <td  height="35" style="">
                                                    <img src="http://www.happy-giraffe.ru/images/mail/blank.gif" height="35" width="100%" border="0" />
                                                </td>
                                            </tr>

                                            <tr>
                                                <td align="center" colspan="2">
                                                    <a href="" style="color:#3482e2; font-size:24px;text-decoration:underline;">Узнать подробнее</a>
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- // END BODY -->

                            ...
                            <div style="padding:10px;border:0;width:318px; background: #83b242">
                                ...
                                <div style="margin-bottom:10px">
															                <span style="color:#0d81d5;font:normal 18px/20px arial,helvetica,sans-serif">
															                    <a href="http://www.parents.ru/article/25-sovetov-kak-otuchit-rebenka-ot-sladkogo/" style="color:#fff;font:bold 20px arial,helvetica,sans-serif; text-decoration: none;margin-top: 14px;display: block;" target="_blank">25 СОВЕТОВ, КАК ОТУЧИТЬ РЕБЕНКА ОТ СЛАДКОГО</a>
															                </span>
                                </div>
                                <div style="margin-bottom:5px">
                                    <a href="http://www.parents.ru/article/25-sovetov-kak-otuchit-rebenka-ot-sladkogo/" style="text-decoration:none" target="_blank">
                                        <img src="http://www.happy-giraffe.ru/mail/headline4.jpg" width="318" border="0" style="display:block" class="CToWUd">
                                    </a>
                                </div>

                                <div style="font:12px arial,helvetica,sans-serif;color:#fff; line-height: 17px; margin: 10px 0 0;">
                                    Современные дети едят слишком много сладостей. Еще 16 лет назад в рационе школьника было в два-три раза меньше сахара. Все это негативно сказывается на детском здоровье. Что делать? Свои рекомендации дают врач и специалист по детскому питанию.
                                ...
                                <table cellpadding="0" cellspacing="0" style="margin-top:10px">
                                    <tbody>
                                    <tr>
                                        <a href="http://www.parents.ru/article/25-sovetov-kak-otuchit-rebenka-ot-sladkogo/" style="background: #fff; color: #E481BB; display: inline-block; padding: 5px 18px; text-align: center; border-radius: 3px; font-size: 14px;margin: 10px 0 0 0; text-decoration: none">Читать далее</a>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>

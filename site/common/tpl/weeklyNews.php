        ...
        <?php foreach ($models as $model): ?>
            <?php if ($i == 1): ?>
                <td style="width:340px;padding-left:20px;" valign="top">
                    ...
                    <div style="padding:10px;border:1px solid #e7e7e7;width:318px;">
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
                            <tbody>
                            <tr>
                                <td valign="middle"><img src="http://img.happy-giraffe.ru/v2/crops/avatarMedium/12/f1/b47b4a50507eb86792531efe5500.jpg"
                                                         style="display:block;margin-top:-40px;-moz-border-radius:36px;-webkit-border-radius:36px;border-radius:36px;">
                                </td>
                                <td valign="top">
                                    <span style="color:#38a5f4;font:12px arial, helvetica, sans-serif;margin-left:10px;">Детский психолог Алиса Калистратова</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <span style="color:#0d81d5;font:bold 18px/20px arial, helvetica, sans-serif;">
                    <a href="http://www.happy-giraffe.ru/community/11/forum/advpost/675554/" target="_blank" style="color:#0d81d5;font:bold 18px/20px arial, helvetica, sans-serif;">Стоит ли приучать малыша к самостоятельному сну?</a></span>
                        </div>

                        <div style="margin-bottom:5px;">
                            <span style="color:#b6b9ba;font:9px tahoma, arial, helvetica, sans-serif;">12 апреля 2015, 11:45</span>
                        </div>


                            <div style="margin-bottom:5px;">
                                <a href="http://www.happy-giraffe.ru/community/11/forum/advpost/675554/" target="_blank" style="text-decoration: none;">
                                    <img src="http://img.happy-giraffe.ru/v2/thumbs/e26e4ffdce15f4bc6711c767ffa68dac/4f/01/dafe9938b6eee9de98af83a424e6.jpg" width="318" border="0" style="display:block;"></a>
                            </div>


                        <div style="font:13px/18px arial, helvetica, sans-serif;color:#040404;">
                            Существует множество различных мнений по поводу того, где должен спать ребёнок от рождения до 3х лет: с родителями или отдельно. Каждая семья ищет свой подход к решению этого вопроса, однако, помимо удобства родителей, следует так же учитывать, психологические особенности малышей такого возраста...
                            <span style="color:#0d81d5;">
                    <a href="http://www.happy-giraffe.ru/community/11/forum/advpost/675554/" target="_blank" style="color:#0d81d5;">Читать&nbsp;всю&nbsp;запись&nbsp;<img
                        ...
                        <span style="color:#31a4f6;font:12px arial, helvetica, sans-serif;">
                            <a href="http://www.happy-giraffe.ru/community/11/forum/advpost/675554/#comment_list" target="_blank" style="color:#31a4f6;font:12px arial, helvetica, sans-serif;"><img

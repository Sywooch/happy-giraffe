                            ...
                            <div style="padding:10px;border:0;width:318px; background: #83b242">
                                ...
                                <div style="margin-bottom:10px">
															                <span style="color:#0d81d5;font:normal 18px/20px arial,helvetica,sans-serif">
															                    <a href="http://www.parents.ru/article/pervaya-fizkultura-malysha/​" style="color:#fff;font:bold 20px arial,helvetica,sans-serif; text-decoration: none;margin-top: 14px;display: block;" target="_blank">ПЕРВАЯ ФИЗКУЛЬТУРА МАЛЫША</a>
															                </span>
                                </div>
                                <div style="margin-bottom:5px">
                                    <a href="http://www.parents.ru/article/pervaya-fizkultura-malysha/​" style="text-decoration:none" target="_blank">
                                ...
                                <div style="font:12px arial,helvetica,sans-serif;color:#fff; line-height: 17px; margin: 10px 0 0;">
                                    Очень важно заниматься не только интеллектуальным, но и физическим развитием малыша. Подсказываем упражнения и какой массаж помогут крохе расти крепким и здоровым
                                ...
                                <table cellpadding="0" cellspacing="0" style="margin-top:10px">
                                    <tbody>
                                    <tr>
                                        <a href="http://www.parents.ru/article/pervaya-fizkultura-malysha/​" style="background: #fff; color: #E481BB; display: inline-block; padding: 5px 18px; text-align: center; border-radius: 3px; font-size: 14px;margin: 10px 0 0 0; text-decoration: none">Читать далее</a>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>

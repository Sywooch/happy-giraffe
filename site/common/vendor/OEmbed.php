...
class OEmbed {
    ...
    function __construct(){
        ...
        $this->providers["|https?://(www\.)?youtube.com/watch.*|i"] = "http://www.youtube.com/oembed";
        $this->providers["|https?://(www\.)?flickr.com/.*|i"] = "http://www.flickr.com/services/oembed/";
        $this->providers["|https?://(www\.)?vimeo.com/.*|i"] = "http://vimeo.com/api/oembed.json";
        $this->providers["|https?://(www\.)?viddler.com/.*|i"] = "http://lab.viddler.com/services/oembed/";
        $this->providers["|https?://(www\.)?rutube.ru/.*|i"] = "http://rutube.ru/api/oembed/";
    }

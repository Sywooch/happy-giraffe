...
class TempCommand extends CConsoleCommand
{
    ...
    {
        $views = GApi::model()->pageViews('http://happy-giraffe.ru/test/pregnancy/', '2013-10-01');
        $uniqueVisitors = GApi::model()->uniquePageViews('http://happy-giraffe.ru/test/pregnancy/', '2013-10-01');
        echo 'Views: ' . $views . "\n";

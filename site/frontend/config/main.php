        ...
        'controllerMap' => array(
            'sitemap' => array(
                ...
                'config' => array(
                    'sitemap.xml' => array(
                        'aliases' => array(
                            'application.controllers_old',
                            'application.modules.cook.controllers_old.RecipeController',
                            'application.modules.services.modules.recipeBook.controllers_old',
                            'application.modules.calendar.controllers_old',
                            'application.modules.services.modules.pregnancyWeight.controllers_old',
                            'application.modules.services.modules.contractionsTime.controllers_old',
                            'application.modules.services.modules.placentaThickness.controllers_old',
                            'application.modules.services.modules.vaccineCalendar.controllers_old',
                            'application.modules.services.modules.menstrualCycle.controllers_old',
                            'application.modules.services.modules.babyBloodGroup.controllers_old',
                            'application.modules.services.modules.repair.controllers_old',
                            'application.modules.services.modules.horoscope.controllers_old',
                            'application.modules.services.modules.test.controllers_old',
                        ),
                    ),
                ),
            ),

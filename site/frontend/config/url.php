...
return array(
    ...
    'rules' => array(
        ...
        'site/<_a:(confirmEmail|resendConfirmEmail|passwordRecovery|passwordRecoveryForm|login|logout|link|out|hh|flushSchema)>' => 'site/<_a>',
...
//        'whatsNew/<_a:(ajax|moreItems)>' => 'whatsNew/default/<_a>',
        ...
        'cook/recipe/<_a:(ac|import|search|searchResult|test|autoSelect|addTag|removeTag|book)>' => 'cook/recipe/<_a>',
        ...
        'contests/pets<contestId:\d+>' => array('community/contest/index', 'defaultParams' => array('contestId' => 1)),
    ),
);
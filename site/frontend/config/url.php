...
//		'<controller:\w+>/<action:\w+>' => '<controller>/<action>',
        ...
        'гороскоп/на-год/<zodiac:[\w]+>'=>'services/horoscope/default/year',
        ...
        'pregnancyWeight/default/<action:\w+>'=>'services/pregnancyWeight/default/<action>',
        'contractionsTime' => 'services/contractionsTime/default/index',
        'placentaThickness' => 'services/placentaThickness/default/index',
        'placentaThickness/default/<action:\w+>'=>'services/placentaThickness/default/<action>',
        'vaccineCalendar' => 'services/vaccineCalendar/default/index',
        'vaccineCalendar/default/<action:\w+>'=>'services/vaccineCalendar/default/<action>',
        'menstrualCycle' => 'services/menstrualCycle/default/index',
        'menstrualCycle/default/<action:\w+>'=>'services/menstrualCycle/default/<action>',
        'babyBloodGroup' => 'services/babyBloodGroup/default/index',
        'hospitalBag' => 'services/hospitalBag/default/index',
        'hospitalBag/default/<action:\w+>'=>'services/hospitalBag/default/<action>',

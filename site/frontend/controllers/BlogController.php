...
//            ),
    ...
    public function actionView($content_id, $user_id, $lastPage = null, $ajax = null)
    {
        ...
        $this->user = User::model()->with(array('blog_rubrics'))->cache(600, new CDbCacheDependency('SELECT max(id) FROM community__contents WHERE author_id='.$content->author_id))->findByPk($content->author_id);

...
class ProductImageController extends AController
{
	/**
...
//			),
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['ProductImage']))
		{
			...
			if($model->save())
				$this->redirect(array('admin','id'=>$model->image_product_id));
		}

...
class ProductVideoController extends AController
{
	/**
	...
	public function actionCreate($id)
	{
		...
		{
			$model->attributes=$_POST['ProductVideo'];
			if($model->validate(array('url')))
			{
				$video = new Video($model->url);
				$model->attributes = $video->getAttributes();
				
				if($model->save())
					$this->redirect(array('admin/product/view', 'id'=>$id));
			}

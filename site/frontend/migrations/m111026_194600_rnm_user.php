<?php
class m111026_194600_rnm_user extends CDbMigration
{
	public function up()
	{
		$this->execute("RENAME TABLE `club_user` TO `user` ;");
	...
	{
		echo "m111026_194600_rnm_user does not support migration down.\n";
		return false;

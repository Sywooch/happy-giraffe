<?php
class m111026_194633_rnm_user_baby extends CDbMigration
{
	public function up()
	{
		$this->execute("RENAME TABLE `club_user_baby` TO `user_baby` ;");
	...
	{
		echo "m111026_194633_rnm_user_baby does not support migration down.\n";
		return false;

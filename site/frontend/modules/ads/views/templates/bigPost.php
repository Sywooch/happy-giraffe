...
<div class="article-anonce article-anonce__red article-anonce__xl">
    <div class="article-anonce_top">
        <a href="#" class="article-anonce_header-a">
            <span href="#" class="ava"><img alt="" src="http://img.happy-giraffe.ru/thumbs/200x200/167771/ava9a3e33bd8a5a29146175425a5281390d.jpg" class="ava_img"></span>
            <span class="article-anonce_author">Марина Правдинина</span>
        </a>
    </div>
    <a href="#" class="article-anonce_hold">
        <div class="article-anonce_img-hold">
            <!-- Может не быть, счетчика фото-->
            ...
            </div><img src="http://placekitten.com/615/410" alt="Наши первые движения они родились в разных странах " class="article-anonce_img">

...
<!--/ layout out -->
<body>
<div class="article-anonce article-anonce__color-<?=$this->model->getOriginEntity()->rubric->forum->club->section_id?><?php if ($this->size == $this::SIZE_BIG): ?> article-anonce__xl<?php endif; ?>">

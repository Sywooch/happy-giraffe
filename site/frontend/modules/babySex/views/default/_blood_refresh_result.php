        ...
        <tr>
            ...
            foreach ($data as $cell) {
                if ($i % 7 == 0 && $i != 0 && count($data) != $i)
                    echo "</tr><tr>";
                $i++;?>
                <td title="<?php echo ($cell['probability']>50)?$cell['probability']:'' ?>">
                    ...
                    <div class="cal_item_default">
                        <div class="cal_item <?php echo $class ?>" <?php echo 'style="opacity:'.$cell['opacity'].'"' ?>>
                    ...
                    <div class="cal_item<?php if ($cell['day'] == $model->baby_d
                        && !$cell['other_month'] && $month == $model->baby_m && $year==$model->baby_y) echo ' active_item' ?>">
                        <?php echo $baby ?>
                        <ins><?php echo $cell['day'] ?></ins>
                    </div>

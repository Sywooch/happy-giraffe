...
<div class="wh_wait wh_son">
    ...
    <p>Внимание! Если вам больше 30 лет – повышен риск рождения ребёнка с хромосомной аномалией. Если вы беременны и
        предполагаете, что зачатие произошло именно в этот день – не волнуйтесь! Обязательно пройдите специальные
        обследования в первом и втором триместрах беременности, чтобы точно знать, что родится здоровый малыш.</p>
</div><!-- .wh_wait -->
<?php endif ?>

...
<div class="wh_wait wh_son" style="margin-bottom: 30px;">
    ...
    <p style="padding-bottom: 6px;">Поздравляем! У вас будет мальчик! Сперматозоид с Y-хромосомой должен оказаться быстрее всех у яйцеклетки и
        оплодотворить её. Однако метод не даёт 100% гарантии. При сбое менструального цикла может появиться и
        девочка.</p>

    <p><i><b>Внимание!</b> Если вам больше 30 лет – повышен риск рождения ребёнка с хромосомной аномалией. Если вы беременны и

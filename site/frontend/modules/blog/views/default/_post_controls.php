    ...
    <?php if ($model->author_id == Yii::app()->user->id):?>
        <div class="article-settings">
            ...
            <div class="article-settings_hold" data-bind="slideVisible: displayOptions()">
                <div class="article-settings_i">
                    <a href="" class="article-settings_a article-settings_a__pin powertip" data-bind="click: attach, css: {active: attached}"></a>
                </div>
                <div class="article-settings_i">
                    <a href="<?=$this->createUrl('form', array('id' => $model->id))?>" data-theme="transparent" class="article-settings_a article-settings_a__edit powertip fancy"></a>
                </div>
                <div class="article-settings_i">
                    <a href="javascript:;" class="ico-users powertip" data-bind="css: {active: displayPrivacy, 'ico-users__friend': privacy() == 1, 'ico-users__all': privacy() == 0}, click: showPrivacy"></a>

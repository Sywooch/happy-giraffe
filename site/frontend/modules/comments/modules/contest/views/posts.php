...
<div class="contest-commentator-blog_top">
    ...
    <p>Для того, чтобы вам было проще, мы предлагаем ТОП-20 актуальнейших статей, которые будут постоянно обновляться! Комментируйте их, отвечайте на комментарии других пользователей, создавайте свои темы и главный приз в 1000 рублей станет вашим!</p>
</div>

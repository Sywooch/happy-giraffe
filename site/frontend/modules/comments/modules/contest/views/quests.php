            ...
            <div class="default-theme">
                <div class="b-froum-theme"><a class="b-froum-theme-img ava__middle ava__female"><img src="<?= $post->author->getAvatarUrl() ?>" alt=""></a>
                    <div class="b-froum-theme-info"><a href="<?= $post->author->getUrl() ?>" class="name"><?= $post->author->getFullName() ?></a>
                        <time class="time"><?= $post->dtimeCreate ?></time><a href="<?= ContestHelper::getValidPostUrl($post->url) ?>" class="b-froum-theme-info-title"><?= $post->title ?></a>
                        <p><?= $post->preview ?></p>
                        <div class="b-froum-theme-info-more clearfix">
                            <div class="float-l lh-34">
                                <div class="c-list_item_btn"><span class="c-list_item_btn__view"><?= $post->views ?></span><span class="c-list_item_btn__users">6</span><a href="#" class="c-list_item_btn__comment"><?=$post->comments_count ?></a></div>
                            </div>

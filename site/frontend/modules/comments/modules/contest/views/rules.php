    ...
    <ol class="contest-commentator-rule_ol">
        ...
        <li class="contest-commentator-rule_li">
            ...
            <ol>
                ...
                <li>Минимум, который необходимо написать для получения приза - 500 комментариев. Все Участники в ТОП-10, не написавшие данный минимум за весь период Конкурса - приз не получают.</li>
            </ol>
        </li>
        <li class="contest-commentator-rule_li">

        ...
        <div class="b-raiting__left float-l">
            <div class="b-raiting-wrapper b-raiting-wrapper_blue clearfix">
                <div class="b-raiting__item float-l">
                    <div class="b-raiting__num b-raiting__num_yellow margin-r15"><?= $i + 1 ?></div><a href="#" class="contest-commentator-rating_user-a">
                        <!-- ava--><span href="<?= $this->leaders[$i]->user->getUrl() ?>" class="ava"><img alt="" src="<?= $this->leaders[$i]->user->getAvatarUrl() ?>" class="ava_img"></span></a>

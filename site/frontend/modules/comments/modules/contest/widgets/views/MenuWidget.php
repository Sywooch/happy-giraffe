<li class="header-menu_li">
    <a href="<?=Yii::app()->createUrl($this->participant === null ? '/comments/contest/default/index' : '/comments/contest/default/posts', array('contestId' => $this->contest->id))?>" class="header-menu_a">

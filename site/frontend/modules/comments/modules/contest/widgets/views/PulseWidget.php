    ...
    <article class="b-article b-article__list clearfix b-article-qa">
        <div class="b-article_cont clearfix">
            <div class="b-article_header clearfix">
                <div class="float-l">
                    <!-- ava--><a href="<?= $comment->author->getUrl() ?>" class="ava ava__female ava__small-xxs ava__middle-xs ava__middle-sm-mid "><span class="ico-status ico-status__online"></span><img alt="" src="<?= $comment->author->getAvatarUrl()?>" class="ava_img"></a><a href="#" class="b-article_author"><?= $comment->author->getFullName() ?></a>
                ...
                <div class="b-post-anonce-s">
                    <div class="b-post-anonce-s_hold">
                        <div class="b-post-anonce-s_header clearfix">
                            <!-- ava--><a href="<?= $comment->post->author->getUrl() ?>" class="ava ava__female ava__small"><span class="ico-status ico-status__online"></span><img alt="" src="<?= $comment->post->author->getAvatarUrl() ?>" class="ava_img"></a><a href="#" class="b-post-anonce-s_author"><?= $comment->post->author->getFullName(); ?></a>
                            <time pubdate="1957-10-04" class="tx-date">Сегодня 13:25</time>

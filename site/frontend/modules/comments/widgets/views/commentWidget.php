<div id="commentsList" class="comments_hold tab-pane active">
    <div class="comments_add">
        <div class="comments_add-hold"> Комментировать от
            <?php $this->widget('site.frontend.modules.signup.widgets.AuthWidget', array('view' => 'comments')); ?> или <a href="#" class="comments_add-a login-button" data-bind="follow: {}">Войти</a>
        </div>

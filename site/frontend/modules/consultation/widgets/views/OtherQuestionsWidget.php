...
<div class="b-consult-aside">
    <div class="b-consult-aside__title">Другие вопросы <a href="<?=Yii::app()->createUrl('/consultation/default/index', array('slug' => $this->question->consultation->slug))?>" class="b-consult-aside__title__all">Все вопросы <?=$count?></a></div>

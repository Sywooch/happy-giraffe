...
<div class="b-consult-aside">
    ...
    <div class="b-consult-aside-item">
        <a href="<?=$question->user->profileUrl?>" class="ava ava__small b-consult-aside-item__ava"><span class="ico-status ico-status__online"></span><img class="ava_img" src="<?=$question->user->avatarUrl?>" alt=""></a>

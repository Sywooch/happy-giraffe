...
<?php if ($contest->id == 4): ?>
    ...
    С уважением, администрация портала «Веселый Жираф»<br /></p>
<?php endif; ?>

<?php if ($contest->id == 5): ?>
    <p style="color: #F66161;">Уважаемые участники конкурса!<br />
        В процесс определения победителей конкурса внесены изменения! Теперь победители будут определяться экспертным жюри из числа первых ста участников, набравших наибольшее количество голосов пользователей сайта «Веселый Жираф».<br />
        <br />
        С уважением,<br />
        администрация портала "Веселый Жираф"<br /></p>
<?php endif; ?>

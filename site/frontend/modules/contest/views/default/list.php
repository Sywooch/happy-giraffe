...
$('#sort').change(function() {
	window.location.href = '" . $this->createAbsoluteUrl('/contest/default/list/' . $contest->id) . "' + $(this).val() + '/';
});
	";
    ...
    <div class="gallery-photos clearfix">
        <ul>
            ...
            <li>
                <table>
                    <tr>
                        <td class="img"><div><?php echo CHtml::link(CHtml::image($w->photo->photo->getPreviewUrl(150, 150), $w->title), $this->createUrl('/contest/default/work/' . $w->id)); ?></div></td>
                    </tr>
                    <tr class="title">

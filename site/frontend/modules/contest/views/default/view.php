...
<div class="contest-about clearfix">
    ...
    <?php if ($contest->id == 4): ?>
        <p style="color: #F66161;"><p>Уважаемые участники конкурса «Веселые брызги»!</p>
        ...
        <p>Результаты конкурса будут объявлены 7.12.2012</p>
        <p>С уважением, администрация портала «Веселый Жираф»</p>
    <?php endif; ?>

            ...
            <ul>
                <?php foreach ($contest->getRelated('works', false, array('limit' => 10, 'order' => 'id desc')) as $w): ?>
                    <li>
                        <table>
                            <tr>
                                <td class="img"><div><?php echo CHtml::link(CHtml::image($w->photo->photo->getPreviewUrl(150, 150), $w->title), $this->createUrl('/contest/default/work', array('contest_id' => $contest->contest_id, 'id' => $w->id))); ?></div></td>
                            </tr>
                            <tr class="title">

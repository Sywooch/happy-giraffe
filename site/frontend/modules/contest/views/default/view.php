...
<div class="contest-about clearfix">
    ...
    <?php elseif ($this->contest->status == Contest::STATUS_ACTIVE): ?>
        <div class="sticker">
            ...
            <?php else: ?>
                <p>Разместите фотографию, на которой ваш малыш совершает большие достижения и примите участие в конкурсе! Не забудьте пригласить друзей в группу поддержки!</p>
                <center>

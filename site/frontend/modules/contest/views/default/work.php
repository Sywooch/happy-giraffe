        ...
        <div class="big-photo">
            <div class="in">
                ...
                <?php if($neighboringWorks['prev']): ?>
                    <?php echo CHtml::link('', array('/albums/photo', 'id' => $neighboringWorks['prev']), array('class' => 'prev')); ?>
                <?php else: ?>
                    <a href="#" class="prev disabled" onclick="return false;"></a>
                <?php endif; ?>
                <?php if($neighboringWorks['next']): ?>
                    <?php echo CHtml::link('', array('/albums/photo', 'id' => $neighboringWorks['next']), array('class' => 'next')); ?>
                <?php else: ?>

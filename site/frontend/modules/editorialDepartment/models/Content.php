...
class Content extends \EMongoDocument
{
    ...
    public function rules()
    {
        return array(
            // Обязательность
            array('forumId, rubricId, title, markDownPreview, htmlTextPreview, markDown, htmlText, authorId, fromUserId', 'required', 'except' => 'blog'),
            ...
            array('forumId, rubricId, authorId, fromUserId', '\site\common\components\HIntegerFilter', 'except' => 'blog'),

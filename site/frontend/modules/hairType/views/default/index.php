...
<div class="seo-text">
    ...
    <p>Постоянно ухудшающаяся экологическая обстановка, неправильное питание, нарушение обмена веществ и ряд других заболеваний влияют на рост и состояние наших волос. А ведь не только женщины, но и мужчины хотят иметь блестящие и здоровые волосы.</p>
    ...
    <p>Но не забывайте и о том, что врачи связывают симптомы ухудшения состояния волос с изменениями, произошедшими в вашем организме и связанными со стрессом или заболеванием нервной системы, с нарушением обмена веществ, гормональными изменениями и рядом иных заболеваний.</p>

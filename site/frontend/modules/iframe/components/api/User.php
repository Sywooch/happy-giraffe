...
namespace site\frontend\modules\iframe\components\api;

use site\frontend\components\api\models\ApiModel;
...
class User extends ApiModel implements \IHToJSON
{
    ...
    {
        parent::afterFind();
        $this->profileUrl = \Yii::app()->createUrl('/iframe/userProfile/default/index',['userId'=>$this->id]);
    }

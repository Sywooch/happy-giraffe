    ...
    <div class="u-notice">
        ...
        <div class="page-col page-col__notice">
            <div class="page-col_top">
                <div class="page-col_t-tx" data-bind="text: tab() == 0 ? 'Новые сигналы' : 'Архив'"></div>
                <!--<a href="" class="u-notice_a-settings">Настройте сигналы</a>-->
                <a href="<?= $this->createUrl('/iframe/default/pediatrician') ?>" class="header-question__close" style="float: right;margin: 20px 0;margin-left: 50px;"></a>
                <a href="" class="u-notice_a-arhive" data-bind="click: markAllAsReaded, visible: tab() == 0"><span class="u-notice_a-arhive-tx">Отметить всё как прочитанное</span><span class="ico-check-gray"></span></a>
            </div>

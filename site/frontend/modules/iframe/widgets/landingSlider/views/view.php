                    ...
                    <div class="section-landing-slider-specialist__item">
                        <div class="section-landing-slider__header">
                            ...
                            <div class="section-landing-slider-specialist__right">
                                <a href="<?=$p['user']->profileUrl?>" class="ava ava--style ava--xl ava--xl_male">
                                ...
                                <div class="b-pediatrician-list-item__box">
                                    ...
                                    <div class="b-pediatrician-list-item__cell"><span class="b-pediatrician-list-item__count"><?=$p['votes']?></span><span class="b-pediatrician-list-item__gray"><?php for ($i = 0; $i < $flowerCount; $i++): ?><span class="b-answer-header-box__ico"></span><?php endfor; ?>&nbsp;&nbsp;Спасибо</span>
                                    </div>
                                </div>
                            </div>
                        </div>

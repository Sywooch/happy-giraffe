<div class="landing-footer landing-footer_bg">
    <div class="landing-footer__left">
    	<div class="landing-footer__phone landing-footer__phone-position"></div>
    </div>
    <div class="landing-footer__right">
        <div class="landing-footer__info textalign-c">

...
<div class="landing__body landing-doctors textalign-c">
    ...
    <ul class="landing-doctors__list">
        ...
        <li class="landing-doctors__li"><span href="#" class="landing-doctors__link"></span>
                ...
                <div class="landing-doctors__descr font__title-sx"><?=$user->specialistInfoObject->title?></div></a>
        </li>
        <?php endforeach; ?>
    </ul>

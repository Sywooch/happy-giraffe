        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
            ...
            <tr>
                <td style="border-top:1px solid #e6e5e5;padding:6px 0;">
                    ...
                    <p style="font:10px tahoma, arial, sans-serif; color: #979696;">Вы получили это письмо, так как являетесь пользователем сайта "Веселый Жираф". <a href="<?php echo $message->createUrl(array('/profile/settings/personal')); ?>" target="_blank" style="color: #3587ec;">Отписаться от рассылки</a></p>
                </td>
            </tr>
            <tr>
                <td  height="10" style="">

...
<td align="center" valign="top">
    <!-- icon -->
    <a href="<?php echo $message->createUrl($message->getCommentsUrlParams(), 'menuIcon'); ?>">
    ...
    <table style="margin: 5px;" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td align="center">
                <a href="<?php echo $message->createUrl($message->getCommentsUrlParams(), 'menuLink'); ?>" style="color: #4a89dc; text-decoration:underline;">Новые<br />комментарии</a>
            </td>
        </tr>
    </table>
</td>

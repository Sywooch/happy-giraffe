...
<?php if ($message->newFavouritesCount > 0): ?>
    ...
    <td align="center" valign="top">
        <!-- icon -->
        <a href="<?php echo $message->createUrl($message->getFavouritesUrlParams(), 'menuIcon'); ?>">
        ...
        <table style="margin: 5px;" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="center">
                    <a href="<?php echo $message->createUrl($message->getFavouritesUrlParams(), 'menuLink'); ?>" style="color: #4a89dc; text-decoration:underline;">В&nbsp;избранное</a>
                </td>
            </tr>
        </table>
    </td>

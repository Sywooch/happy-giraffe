...
<?php if ($message->newFavouritesCount > 0): ?>
    <td  height="10" style="">
        <img src="<?php echo Yii::app()->request->hostInfo; ?>/images/mail/blank.gif" height="10" width="20" border="0" />
    </td>
    <td align="center" valign="top">
        <!-- icon -->
        <a href="<?php echo $message->createUrl($message->getFavouritesUrlParams(), 'menuIcon'); ?>" target="_blank">
                            ...
                            <table style="margin: 2px 3px 0 5px;" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="right" style="color: #fff;">
                                        <span style="padding: 1px 5px;border-radius: 10px; border: 2px solid #ffffff;background:#f84219;color:#ffffff;font-size:12px;line-height:14px;vertical-align:top; display:inline-block;"><?php echo $message->newFavouritesCount; ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <table style="margin: 5px;" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="center">
                    <a href="<?php echo $message->createUrl($message->getFavouritesUrlParams(), 'menuLink'); ?>" style="color: #4a89dc; text-decoration:underline;" target="_blank">В&nbsp;избранное</a>
                </td>
            </tr>
        </table>
    </td>

...
<tr>
    <td valign="top" style="padding-top: 5px;padding-right: 2px;">
        <img src="<?php echo Yii::app()->request->hostInfo; ?>/images/mail/avatar.jpg" style="display:block;border-radius:36px;">
    </td>
    <td valign="top">
    ...
    <td valign="top" bgcolor="#edfaff" style="background: #edfaff; padding: 12px 20px 15px 15px;border-radius: 5px;">
        <table style="" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <a href="" style="color:#289fd7;text-decoration:none;">Ангелина Богоявленская</a>
                </td>
            </tr>
            <tr>
                <td style="padding-top: 7px;padding-bottom: 10px;">
                    Меняя название трека в альбоме он автоматически производит.
                </td>
            </tr>
            <tr>
                <td>
                    <a href="" style="color: #fefefe; background: #50b145; padding: 1px 4px;text-decoration:none;">Ответить</a>
                </td>
            </tr>
        </table>
    </td>

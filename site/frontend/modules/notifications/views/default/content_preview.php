...
<div class="user-notice-list_post js-powertip-white"
    ...
    <?php if (!empty($photo)): ?>
        <div class="user-notice-list_post-img<?php if (method_exists($model, 'isVideo') && $model->isVideo()) echo ' user-notice-list_post-img__video' ?>"><img src="<?= $photo->getPreviewUrl(60, 40, false, true) ?>"></div>
    <?php endif ?>

...
<div class="info-hero">
    <div class="info-media-block">
        ...
        <div class="info-media-block__part info-hero__media text-center">
            <div class="info-media-block__item">
                <div class="info-form-title">Наш медиа-кит</div>
                <div class="info-form-ms text-center"><a href="/adv/media/happy-giraffe-2015-08.pdf" class="info-form__button">Скачать</a></div>
            </div>
            <div class="info-media-block__item">
                <div class="info-form-title">Наши кейсы</div>
                <div class="info-form-ms text-center"><a href="/adv/media/happy-giraffe-cases-2015-08.pdf" class="info-form__button">Скачать</a></div>
            </div>
        </div>
        <div class="clearfix"></div>
    </div>

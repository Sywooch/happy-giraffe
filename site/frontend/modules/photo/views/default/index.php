        ...
        <section class="b-album"><a href="" class="b-album_img-hold">
            ...
            <div class="b-album_overlay"><a class="b-album_r">
                ...
                <ul class="b-album_prev clearfix">
                    ...
                    <!-- /ko -->
                    <li class="b-album_prev-li"><a href="" class="album-photo-add" data-bind="photoUpload: { data: { multiple: true, collectionId: $data.photoCollection().id() }, callback: function() {} }"></a></li>
                </ul>
            </div>
        </section>
    <!-- /ko -->
    <!-- ko if: emptyAlbums().length > 0 -->
        ...
        <!-- ko foreach: emptyAlbums -->
            <div class="album-empty">
                ...
                <a href="" class="album-photo-add" data-bind="photoUpload: { data: { multiple: true, collectionId: $data.photoCollection().id() }, callback: function() {} }"></a>

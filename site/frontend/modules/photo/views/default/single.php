    ...
    <div class="b-main_col-hold clearfix">
        ...
        <div class="b-article clearfix">
            <div class="wysiwyg-content">
                <p>Ну наконец-то я дождалась своего отпуска, мне даже не верится что этот день настал Когда сегодня приехала домой, села на диван и такая усталость меня накрыла </p>
            </div>
        </div>
                ...
                <div id="commentsList" class="comments_hold tab-pane active">
                    <div class="comments_add">
                        <div class="comments_add-hold"> Комментировать от
                            <div class="ico-social-hold"><a href="" class="ico-social ico-social__odnoklassniki"></a><a href="" class="ico-social ico-social__vkontakte"></a></div> или <a class="comments_add-a">Войти</a>
                        </div>
                    </div>
                    <ul class="comments_ul">
                        ...
                        <li class="comments_li comments_li__lilac">
                            ...
                            <ul class="comments_ul">
                                ...
                                <!-- комментарий вложенный-->
                                <!-- Свой комментарий-->
                                <li class="comments_li comments_li__self comments_li__lilac">
                                    <div class="comments_i clearfix">
                                        <div class="comments_ava">
                                            <!-- Аватарки размером 40*40-->

...
<div class="seo-text">
    <span class="summary-title">Это важное детское место – плацента</span>
    ...
    <ul style="list-style-type: decimal;">
        ...
        <li>
            Место прикрепления плаценты может быть любым, чаще она локализуется на задней поверхности матки.
        </li>
        <li>
            Толщина плаценты определяется при проведении УЗИ. В России толщина плаценты с 20-й недели составляет в норме
    ...
    <div class="brushed">
    <p style="font-style: italic;font-weight: bold;margin-top:0;">Наш сервис даёт возможность определить соответствие толщины

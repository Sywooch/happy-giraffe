<div class="b-main_cont">
    ...
    <?php if($this->beginCache('Forums.ClubsWidget', array('duration' => 1))) {$this->widget('site\frontend\modules\posts\modules\forums\widgets\clubs\ClubsWidget'); $this->endCache();} ?>

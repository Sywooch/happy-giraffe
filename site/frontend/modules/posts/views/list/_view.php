...
<article class="b-article b-article__list clearfix">
    <div class="b-article_cont clearfix">
        ...
        <?php if (!isset($data->templateObject->data['type']) || $data->templateObject->data['type'] !== 'status') { ?>
        ...
        <?php /*
          ...
          <div class="like-control_tx">&nbsp;</div></a></div>
          <div class="like-control_hold visible-md-inline-block"><a href="#" title="В избранное" onclick="openLoginPopup(event); return false;" class="like-control_i powertip">

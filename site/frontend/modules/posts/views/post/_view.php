...
Yii::app()->clientScript->registerAMD('vk_comments', array('vk2'), 'VK.init({apiId: 2855330, onlyWidgets: true}); VK.Widgets.Comments("vk_comments", {limit: 10, width: "600", attach: "*", pageUrl: "' . $this->post->url . '"});');
?>
<!-- Основная колонка-->

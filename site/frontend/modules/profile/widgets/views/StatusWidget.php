        ...
        <?php if ($this->isMyProfile):?>
            <div class="article-settings">
                ...
                <div class="article-settings_hold" style="display: none;">
                    <div class="article-settings_i">
                        <a href="<?=Yii::app()->createUrl('/blog/default/form', array('type' => 5, 'redirect'=>'/user/'.Yii::app()->user->id))?>" class="article-settings_a article-settings_a__add powertip fancy-top" title="Редактировать"></a>
                    </div>
                    <div class="article-settings_i">

    ...
    <div class="userSection_hold">
        <div class="userSection_left">
            ...
            <div class="userSection_btn-hold clearfix">
                ...
                <a href="<?=Yii::app()->user->isGuest ? '#loginWidget' : Yii::app()->createUrl('/messaging/default/index', array('interlocutorId' => $this->user->id))?>" class="userSection_btn userSection_btn__dialog powertip popup-a"><span class="userSection_ico"></span></a>
            </div>
        </div>

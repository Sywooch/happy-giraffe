<div id="repair-ceiling">
    ...
    <div class="recommendation clearfix">
        ...
        <p>Рассчитанное количество материалов является точным для потолка правильной прямоугольной формы. Если ваш
            потолок имеет сложную форму, то возьмите материалы с запасом от 10 до 25%.</p>

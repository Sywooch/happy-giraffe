...
<div class="col-white-hoar">
    <div id="baby">
        ...
        <div class="child_sex_china_banner">
            ...
            <input type="submit" class="btn-gold btn-big" value="Рассчитать"/>
        ...
        <div id="china-calendar-result clearfix">
        ...
        <div class="margin-20">
            <div class="wysiwyg-content">
                <h2 class="h2-services">Китайский метод определения пола ребенка</h2>

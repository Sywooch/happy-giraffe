...
Yii::app()->clientScript->registerMetaTag('Определение пола: китайский метод считается одним из самых древних, а потому достаточно часто оказывается точным. Введите месяц и год рождения матери, затем месяц и год зачатия ребенка и посмотрите, кто у вас будет.', 'description');
...
<div class="seo-text">
    <div class="summary-title">Китайский метод определения пола ребенка</div>

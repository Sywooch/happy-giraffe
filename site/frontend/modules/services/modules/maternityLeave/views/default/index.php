<?php Yii::app()->clientScript->registerMetaTag('Как точно рассчитать декретный отпуск, сроки которого строго определены, но индивидуальны для каждой женщины? Предлагаем вам сделать расчет декрета при помощи нашего сервиса и узнать точно, когда можно оставить свое рабочее место', 'description');
?><div id="decree-time">

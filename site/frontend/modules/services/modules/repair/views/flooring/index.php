<?php Yii::app()->clientScript->registerMetaTag('Перед тем как купить линолеум, паркет или ламинат, нужно сделать расчет: сколько этих материалов понадобится, чтобы покрыть ими нужную площадь пола в помещении? Считайте при помощи нашего сервиса и покупайте столько, сколько нужно', 'description');
?><div id="repair-floor">

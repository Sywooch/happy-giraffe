<?php Yii::app()->clientScript->registerMetaTag('Краска практически всегда используется при проведении ремонтных работ. Сделайте точный расчет краски и узнайте, сколько её понадобится для покрытия конкретной поверхности в один слой при помощи нашего нового сервиса. Заходите!', 'description');
?><div id="repair-paint">

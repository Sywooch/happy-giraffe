<?php
Yii::app()->clientScript->registerMetaTag('Подвесные потолки – это очень красиво, удобно и функционально. Хотите узнать, сколько материалов вам понадобится, особенно если вы задумали сделать подвесной потолок своими руками? Наш сервис к вашим услугам!', 'description');

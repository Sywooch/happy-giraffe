...
<div class="seo-text">
    ...
    <div class="brushed">
        ...
        <p>Сначала нужно связать образец из выбранной пряжи в виде квадрата со сторонами по 10 сантиметров. Его нужно
            намочить, высушить, не растягивая, и чуть-чуть прогладить. Берём линейку – отмеряем 10 сантиметров в ширину
            и считаем, сколько в них поместилось петель. Потом измеряем длину и считаем, сколько в них поместилось
            рядов.</p>

        <p>Теперь всё просто.</p>
        <ul>
            <li>Вводим полученные данные в соответствующие поля специальной формы.</li>
            <li>Измеряем длину и ширину изделия и вводим их тоже в соответствующие поля формы.</li>
        </ul>

...
namespace site\frontend\modules\som\modules\photopost\behaviors;
...
class ConvertBehavior extends \CActiveRecordBehavior
{
    ...
    public function afterSave()
    {
        ...
        $labels = is_null($this->owner->forumId) ? Label::model()->findForBlog() : Label::model()->findByForum($this->owner->forumId);

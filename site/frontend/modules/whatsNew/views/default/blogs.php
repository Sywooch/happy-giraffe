<?php
    Yii::app()->clientScript
        ...
        ->registerScript('Realplexor-reg-whatsNew', 'comet.connect(\'http://' . Yii::app()->comet->host . '\', \'' . Yii::app()->comet->namespace . '\', \'whatsNewBlogs\');')
    ;
    ...
    <div class="content-cols clearfix">
        ...
        <div class="col-3 clearfix">
            <div class="best-users tabs">
                <div class="best-users_title">Лучшие блоггеры</div>

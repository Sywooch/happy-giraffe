...
<div class="masonry-news-list_content">
    <?php if ($data->recipe->mainPhoto !== null): ?>
        <div class="title-img">
            <?=CHtml::link(HHtml::lazyImage($data->recipe->mainPhoto->getPreviewUrl(198, null, Image::WIDTH), $data->recipe->title).'<span class="btn-view">Посмотреть</span>', 'javascript:void(0)', array('data-id' => $data->recipe->mainPhoto->id))?>
        </div>
    <?php endif; ?>

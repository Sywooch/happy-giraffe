        ...
        <div class="header-fix_hold clearfix"><a href="/" class="header-fix_logo"></a>
            ...
            <div class="header-fix-menu">
                <ul class="header-menu_ul clearfix">
                    ...
                    <li class="header-fix-menu_li"><a href="<?=$this->createUrl('/messaging/default/index')?>" class="header-fix-menu_a"><span class="header-fix-menu_tx">диалоги</span><span class="header-fix-menu_count" data-bind="text: newMessagesCount, visible: newMessagesCount() > 0 && activeModule() != 'messages'"></span></a></li>
        ...
        <div class="header_hold clearfix">
            ...
            <div class="header-menu">
                <ul class="header-menu_ul clearfix">
                    ...
                    <li class="header-menu_li" data-bind="css: { active : activeModule() == 'messaging' }"><a href="<?=$this->createUrl('/messaging/default/index')?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__im"></span><span class="header-menu_tx">Диалоги</span><span class="header-menu_count" data-bind="text: newMessagesCount, visible: newMessagesCount() > 0 && activeModule() != 'messages'"></span></a></li>
                    ...
                    <li class="header-menu_li header-menu_li__dropin" data-bind="css: { active : menuExtended }, click: function(data, event) {event.stopPropagation()}">

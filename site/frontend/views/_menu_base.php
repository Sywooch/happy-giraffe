    ...
    <div class="header_hold clearfix">
        ...
        <div class="header-menu">
            <ul class="header-menu_ul clearfix">
                ...
                <li class="header-menu_li"><a href="<?=$this->createUrl('/som/activity/onAir/index')?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__broadcast"></span><span class="header-menu_tx">Прямой эфир</span></a></li>

    ...
    <div class="header_hold clearfix">
        ...
        <div class="header-menu">
            <ul class="header-menu_ul clearfix">
                <?php $this->widget('site\frontend\modules\comments\modules\contest\widgets\MenuWidget', array('userId' => Yii::app()->user->id)); ?>
                <li class="header-menu_li"><a href="<?=$this->createUrl('/posts/onAir/default/index')?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__broadcast"></span><span class="header-menu_tx">Прямой эфир</span></a></li>
                <li class="header-menu_li" data-bind="css: { active : activeModule() == 'myGiraffe' }"><a href="<?=$this->createUrl('/posts/myGiraffe/default/index')?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__giraffe"></span><span class="header-menu_tx">Мой Жираф</span><span style='display:none;' class="header-menu_count" data-bind="text: newPostsCount, visible: newPostsCount() > 0 && activeModule() != 'myGiraffe'"></span></a></li>

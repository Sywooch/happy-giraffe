...
<div class="header-drop">
    <div class="header-menu clearfix">
        <ul class="header-menu_ul">
            ...
            <li class="header-menu_li"><a href="<?=$this->createUrl('/scores/default/index')?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__award"></span><span class="header-menu_tx">Успехи</span></a></li>

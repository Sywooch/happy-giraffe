...
<div class="header-drop">
    <div class="header-menu clearfix">
        <ul class="header-menu_ul">
            ...
            <li class="header-menu_li"><a href="<?=$this->createUrl('/gallery/user/index', array('user_id' => $user->id))?>" class="header-menu_a"><span class="header-menu_ico header-menu_ico__photo"></span><span class="header-menu_tx">Фото</span></a></li>

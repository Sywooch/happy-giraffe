...
<?php $this->renderPartial(in_array(get_class($model), array('CommunityContentGallery', 'Contest')) && false ? 'w_photo_banner' : 'w_photo_simple', compact('photo', 'title', 'model', 'currentIndex', 'count', 'preload', 'photos')); ?>
<div id="photo-window-in">
    <div class="top-line">
        <div class="wrapper">
            <a href="javascript:void(0);" class="close" onclick="closePhoto();">закрыть<i class="icon"></i></a>
            <div class="count">Всего в альбоме 98 фотографий</div>
        </div>
    </div>
    ...
    <div id="photo-thumbs">
        <div class="jcarousel">
            <ul>
                <li class="active"><a href="javascript:void(0);"><img src="/images/example/ex6.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex2.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex1.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex6.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex2.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex5.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex4.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex1.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex2.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex3.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex4.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex2.png" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex5.jpg" /></a></li>
                <li><a href="javascript:void(0);"><img src="/images/example/ex4.jpg" /></a></li>
        ...
        <a href="javascript:void(0);" class="prev" onclick="$('#photo-thumbs .jcarousel').jcarousel('scroll', '-=1');">предыдущая</a>
        <a href="javascript:void(0);" class="next" onclick="$('#photo-thumbs .jcarousel').jcarousel('scroll', '+=1');">следующая</a>
    </div>

    <div id="photo">

        <div class="img">
            <img src="/images/example/ex6.jpg" />
        ...
        <a href="" class="prev">предыдушая</a>

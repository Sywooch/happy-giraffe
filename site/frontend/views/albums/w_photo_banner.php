<div id="photo-window-in" class="photo-window-banner">
        ...
        <div class="content-cols clearfix photo-container">
            ...
            <div class="col-3">
                <div class="margin-t145" id="AdfoxAjax">
                    <iframe id="direct" src="http://www.happy-giraffe.ru/rtb.html" width="200" height="300" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function rtb_refresh() {
            ...
            var url = 'http://www.happy-giraffe.ru/rtb.html?r=' + r;
            $('#direct').attr('src', url);
        }
    </script>

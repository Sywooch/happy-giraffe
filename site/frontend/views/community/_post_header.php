<div class="entry-header">
    ...
    <noindex>
        ...
        <div class="meta">
            ...
            <div class="views"><span href="#" class="icon"></span> <span><?=($full) ? $this->getViews() : PageView::model()->viewsByPath(str_replace('http://www.happy-giraffe.ru', '', $model->url), true)?></span></div>
            <div class="comments">
                <a href="#" class="icon"></a>

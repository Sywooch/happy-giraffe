...
<!--[if gt IE 9]><!--> <html class=""> <!--<![endif]-->
    ...
    <body class="body-gray<?php if ($this->bodyClass !== null): ?> <?=$this->bodyClass?><?php endif; ?>" id="body">
        ...
        <script type="text/javascript">
            ...
            AdFox_getCodeScript(1,pr1,'//ads.adfox.ru/211012/prepareCode?pp=g&amp;ps=bkqy&amp;p2=ewfb&amp;pct=a&amp;plp=a&amp;pli=a&amp;pop=a&amp;pr=' + pr +'&amp;pt=b&amp;pd=' + addate.getDate() + '&amp;pw=' + addate.getDay() + '&amp;pv=' + addate.getHours() + '&amp;prr=' + afReferrer + '&amp;pdw=' + scrwidth + '&amp;pdh=' + scrheight + '&amp;dl='+dl+'&amp;pr1='+pr1);
            // -->
        </script>

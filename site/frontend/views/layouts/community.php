    ...
    <div id="joinClub" class="popup-confirm popup">
        ...
        <div class="confirm-before">
            ...
            <div class="bottom">
                ...
                <?=HHtml::link('<span><span>Вступить в клуб</span></span>', array('community/join', 'action' => 'join', 'community_id' => $this->community->id), array('class' => 'btn btn-green-medium joinButton'), false)?>
            </div>
        </div>

...
<?php if (Yii::app()->vm->version == VersionManager::VERSION_DESKTOP): ?>
    <? if ((! ($this instanceof site\frontend\modules\posts\controllers\PostController) && ! $this->hideAdsense) || ($this->post && $this->post->isNoindex == 0 && ! $this->post->templateObject->getAttr('hideAdsense', false))): ?>

            ...
            <?php if (! Yii::app()->user->isGuest): ?>
                <div class="user-widget-block user-widget-block_mod" data-bind="css: { 'user-widget-block_open': menuExtended() }, click: function(data, event) {event.stopPropagation(); return true;}">
                    <ul class="user-widget-block__list">
                        <li class="user-widget-block__li"><a href="<?=Yii::app()->user->model->getUrl()?>" class="user-widget-block__link"><span class="user-widget-block__bg user-widget-block__bg_profile"><img src="http://img.happy-giraffe.ru/avatars/12963/ava/8d26a6f4dbae0536f8dbec37c0b5e5f8.jpg" class="user-widget-block__ava"></span><span class="user-widget-block__text">Анкета</span></a></li>

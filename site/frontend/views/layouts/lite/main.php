            ...
            <div class="layout-footer clearfix">
                <div class="layout-footer_hold">
                    ...
                    <ul class="footer-menu visible-md">
                        ...
                        <li class="footer-menu_li"><a href="" class="footer-menu_a footer-menu_a__husband-and-wife">Мужчина и женщина</a></li>
                        <li class="footer-menu_li"><a href="" class="footer-menu_a footer-menu_a__hobby">Интересы и увлечения</a></li>
                        <li class="footer-menu_li"><a href="" class="footer-menu_a footer-menu_a__family-holiday">Отдых</a></li>
                    </ul>

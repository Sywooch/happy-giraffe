...
<body class="body body__bg2 body_competition <?php if ($this->bodyClass !== null): ?> <?=$this->bodyClass?><?php endif; ?>">
    <script>
        /*меню юзера*/
        $(function () {
            /*меню юзера*/
...
//            }).trigger('resize');
            ...
            /*Мобильное меню*/
            $('.js-mobile-menu, .js-overlay-menu').on('click', function () {
                console.log('dwfsdfew');

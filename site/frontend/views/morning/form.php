...
<div class="morning-edit form">
    ...
    <div class="pos clearfix">
        <div class="text"><?=$post->morning->position ?></div>
        <div class="input" style="display:none;">
            <input type="text" value="<?=$post->morning->position ?>">
    ...
    <div<?php if (empty($post->title)) echo ' style="display:none;"' ?>>
        ...
        <div class="photos">
            <div>
                <?php foreach ($post->morning->photos as $photo): ?>
                ...
                <div class="add">
                    <a href="javascript:void(0);" class="fake_file">
                        ...
                        <?php echo CHtml::hiddenField('id', $post->morning->id); ?>

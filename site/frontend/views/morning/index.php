...
?><div class="entry">
    ...
    <div class="entry-content">
        ...
        <div class="morning-images clearfix">
            <div class="big"><img src="<?= $article->morningPost->getPhotoUrl(0) ?>"></div>
            <div class="thumbs">
                <ul>
                    <li><img src="<?= $article->morningPost->getPhotoUrl(1) ?>"></li>
                    <li><img src="<?= $article->morningPost->getPhotoUrl(2) ?>"></li>
                    <?php if (count($article->morningPost->photos) > 3): ?>
                    <li><a href="<?=$article->url ?>" class="more"><i
                        class="icon"></i>еще <?= count($article->morningPost->photos) - 3 ?> фото</a></li>
                    <?php endif ?>
                </ul>
            </div>
        </div>

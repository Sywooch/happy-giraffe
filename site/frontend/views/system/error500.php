...
<head>
    ...
    <!-- custom select-->
    <script src="/new/javascript/select2.js"></script>
    <!-- wisywig-->
    <script src="/new/redactor/redactor.js"></script>
    <script src="/new/javascript/jquery.Jcrop.js"></script>
                ...
                <div class="content-cols clearfix">
                    <div class="utilites-error">
                        <div class="utilites-error_hold">
                            ...
                            <div class="utilites-error_sub-tx">На сервере произошла непредвиденная ошибка. Пожалуйста, подождите <br> она вскоре будет исправлена</div><a href="http://www.happy-giraffe.ru/" class="btn-arrow btn-arrow__next btn-l btn-green-simple"><span class="btn-arrow_ico"><i class="ico-arrow-r"></i></span><span class="btn-arrow_tx">На главную страницу</span></a>
                        </div>
                    </div>
                </div>
            </div>

<div class="admin-buttons">
    ...
    <?php if (get_class($model) == 'BlogContent'): ?>
        ...
        <?php if ($model->type_id == 2): ?>
            <a class="lilac add-to-favourites<?php if (Favourites::inFavourites($model, 5)) echo ' active'; ?>" href="#"
               onclick="Favourites.toggle(this, 5);return false;">В<span class="tip">Поместить в Видео Дня</span></a>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if (get_class($model) == 'CommunityContent'): ?>
        ...
        <?php if ($model->rubric->community_id == 26): ?>
            <a class="blue add-to-favourites<?php if (Favourites::inFavourites($model, 4)) echo ' active'; ?>" href="#"
               onclick="Favourites.toggle(this, 4, 26);return false;">Д<span class="tip">Поместить в Дизайн</span></a>
        <?php endif; ?>
        ...
        <?php if ($model->rubric->community_id == 22): ?>
            <a class="yellow add-to-favourites<?php if (Favourites::inFavourites($model, 4)) echo ' active'; ?>" href="#"
               onclick="Favourites.toggle(this, 4, 22);return false;">К<span class="tip">Поместить в Кулинарию</span></a>
        <?php endif; ?>

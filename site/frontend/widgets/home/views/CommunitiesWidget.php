    ...
    <ul>
        ...
        <li class="manwoman">
            ...
            <ul>
                ...
                <li>
                    <a href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 32))?>">

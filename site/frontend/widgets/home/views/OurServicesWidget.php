<div class="box homepage-services">
    ...
    <div class="clearfix">
        ...
        <div class="fast-service child-gender">
            ...
            <ul>
                <li><a href="<?=Yii::app()->createUrl('/babySex/china/') ?>">Китайский метод</a></li>
                <li><a href="<?=Yii::app()->createUrl('/babySex/japan/') ?>">Японский метод</a></li>
                <li><a href="<?=Yii::app()->createUrl('/babySex/bloodRefresh/') ?>">По дням рождения</a></li>
                <li><a href="<?=Yii::app()->createUrl('/babySex/blood/') ?>">По группе крови</a></li>
                <li><a href="<?=Yii::app()->createUrl('/babySex/ovulation/') ?>">По овуляции</a></li>
            </ul>
        ...
        <div class="fast-service child-name">
            ...
            <big><a href="<?=Yii::app()->createUrl('/names') ?>">Выбираем имя</a></big>

...
<div id="user-dialogs" class="clearfix" style="display: none;">
    ...
    <div class="header">
        ...
        <div class="nav">
            <ul id="user-dialogs-nav">
                <li><a onclick="Messages.setList(0);" href="javascript:void(0)">Все</a><span class="count" id="user-dialogs-allCount"></span></li>
                <li><a onclick="Messages.setList(1);" href="javascript:void(0)">Новые</a><span class="count" id="user-dialogs-newCount"></span></li>
                <li><a onclick="Messages.setList(2);" href="javascript:void(0)">Кто в онлайне</a><span class="count" id="user-dialogs-onlineCount"></span></li>
                <li><a onclick="Messages.setList(3);" href="javascript:void(0)">Друзья на сайте</a><span class="count" id="user-dialogs-friendsCount"></span></li>
            </ul>
        </div>

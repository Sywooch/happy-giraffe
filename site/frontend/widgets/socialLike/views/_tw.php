...
$url = isset($this->options['url']) ? $this->options['url'] : Yii::app()->createAbsoluteUrl(Yii::app()->request->pathInfo);
$text = isset($this->options['title']) ? ' data-text="' . $this->options['title'] . '"' : '';
?>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $url; ?>"<?php echo $text ?>>Tweet</a>
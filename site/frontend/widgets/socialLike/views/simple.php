            ...
            <table width="100%">
                <tr>
                    <td style="vertical-align:top;padding-right:35px;text-align: left;">
                        <iframe src="//www.facebook.com/plugins/like.php?href=<?=urlencode('http://www.'.$_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]) ?>&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;action=like&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe>
                    </td>

            ...
            C.on('editingBlockReady', function () {
                ...
                C.addMode('wysiwyg', {load:function (V, W, X) {
                    ...
                    if (X) {
                        ...
                        V = Y + V;
                    } else V = W.docType + '<html dir="' + W.contentsLangDirection + '"' + ' lang="' + (W.contentsLanguage || C.langCode) + '">' + '<head>' + '<title>' + E + '</title><script type="text/javascript">document.domain = "'+document.domain+'";</script>' + aa + Z + '</head>' + '<body' + (W.bodyId ? ' id="' + W.bodyId + '"' : '') + (W.bodyClass ? ' class="' + W.bodyClass + '"' : '') + '>' + V + '</html>';

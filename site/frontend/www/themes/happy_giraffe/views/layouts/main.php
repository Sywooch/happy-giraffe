                        ...
                        <div class="in">
                            ...
                            <ul class="cols cols-5">
                                <li class="col">
                                    ...
                                    <div class="col-in" style="background-image:url(/images/nav_kids_img_01.jpg)">
                                ...
                                <li class="col">
                                    ...
                                    <div class="col-in" style="background-image:url(/images/nav_kids_img_02.jpg)">
                                ...
                                <li class="col">
                                    ...
                                    <div class="col-in" style="background-image:url(/images/nav_kids_img_03.jpg)">
                                ...
                                <li class="col">
                                    ...
                                    <div class="col-in" style="background-image:url(/images/nav_kids_img_04.jpg)">
                                ...
                                <li class="col">
                                    ...
                                    <div class="col-in" style="background-image:url(/images/nav_kids_img_05.jpg)">
                        ...
                        <div class="in">
                            ...
                            <ul class="cols cols-2">
                                <li class="col wedding">
                                    <a class="big-link" style="background-image:url(/images/nav_manwoman_img_01.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 32))?>">
                                ...
                                <li class="col relationships">
                                    <div class="col-in" style="background-image:url(/images/nav_manwoman_img_02.jpg);">
                    ...
                    <div class="drp">
                        <div class="in">
                            ...
                            <ul class="cols cols-3">
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_beauty_img_01.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 29))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_beauty_img_02.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 30))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_beauty_img_03.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 33))?>">
                ...
                <li class="home navdrp">
                    ...
                    <div class="drp">
                        <div class="in">
                            ...
                            <ul class="cols cols-5">
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_home_img_01.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 22))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_home_img_02.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 23))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_home_img_03.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 26))?>">
                                        <span class="title">Интерьер и дизайн</span>
                                        <span class="text">Советы о том, как превратить свое жилье в уютное гнездышко.</span>
                                    </a>
                                </li>
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_home_img_04.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 28))?>">
                    ...
                    <div class="drp">
                        <div class="in">
                            ...
                            <ul class="cols cols-4">
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_hobbies_img_01.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 24))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_hobbies_img_02.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 25))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_hobbies_img_03.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 27))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_hobbies_img_04.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 35))?>">
                ...
                <li class="rest navdrp">
                    ...
                    <div class="drp">
                        <div class="in">
                            ...
                            <ul class="cols cols-3">
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_rest_img_01.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 19))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_rest_img_02.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 21))?>">
                                ...
                                <li class="col">
                                    <a class="big-link" style="background-image:url(/images/nav_rest_img_03.jpg);" href="<?= Yii::app()->createUrl('/community/list', array('community_id' => 20))?>">

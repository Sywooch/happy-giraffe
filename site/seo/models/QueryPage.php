...
/**
 * This is the model class for table "query_pages".
 *
 * The followings are the available columns in table 'query_pages':
 * @property string $id
...
class QueryPage extends HActiveRecord
{
	 ...
	 * @return QueryPage the static model class
	 */
    ...
    {
        return 'happy_giraffe_seo.query_pages';
    }

...
{
    $counts = array(
        1 => SiteKeywordVisit::model()->count($model->getMainCriteria($type)->addCondition(Keyword::getFreqCondition(1))),
        2 => SiteKeywordVisit::model()->count($model->getMainCriteria($type)->addCondition(Keyword::getFreqCondition(2))),
        3 => SiteKeywordVisit::model()->count($model->getMainCriteria($type)->addCondition(Keyword::getFreqCondition(3))),
        4 => SiteKeywordVisit::model()->count($model->getMainCriteria($type)->addCondition(Keyword::getFreqCondition(4))),
    );

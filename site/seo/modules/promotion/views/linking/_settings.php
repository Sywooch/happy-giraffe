<div class="linking-filter tabs">
    <div class="nav">
        ...
        <ul>
            <li class="active"><a href="javascript:void(0)" onclick="setTab(this, 1);"><i class="icon-yandex"></i> Яндекс</a></li>
            <li><a href="javascript:void(0)" onclick="setTab(this, 2);"><i class="icon-google"></i> Google</a></li>
        </ul>
    </div>
        ...
        <div class="tab-box tab-box-1" style="display:block;">
            ...
            <form action="">
                ...
                <tr>
                    ...
                    <td class="col-5" rowspan="2"><button class="btn-g" onclick="SaveSettings(this);return false;">Ok</button></td>
                </tr>
                <tr>
            ...
            <form action="">
                ...
                <table class="table-2">
                    ...
                    <tr>
                        ...
                        <td class="col-3"><button class="btn-g" onclick="SaveSettings(this);return false">Ok</button></td>
                    </tr>

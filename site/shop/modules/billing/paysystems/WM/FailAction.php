<?php
class FailAction extends PSAction
{

    public function run()
    {
		$payment = $this->handledPayment = BillingPayment::model()->findByPk(intval($POST['LMI_PAYMENT_NO']), 'payment_accept_time>0');

		$payment->invoke('fail', $_POST, time());
